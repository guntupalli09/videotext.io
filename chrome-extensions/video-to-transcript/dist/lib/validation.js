...
export const ACCEPTED_EXTENSIONS = [...VIDEO_EXTENSIONS, ...AUDIO_EXTENSIONS];
...
export function isAudioFile(file) {
    if (file.type && file.type.startsWith('audio/'))
        return true;
    return AUDIO_EXTENSIONS.includes(fileExtension(file.name));
}
 ...
 */
export function readMediaDurationSeconds(file) {
 ...
 */
export async function preflight(file, limits) {
