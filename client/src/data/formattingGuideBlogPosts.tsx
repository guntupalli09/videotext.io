...
export const FORMATTING_GUIDE_BLOG_POSTS: FormattingGuideBlogPost[] = [
  {
    ...
    content: (
      <div className="space-y-4 text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        <p>
          <Link
            className="inline-flex items-center justify-center rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium px-4 py-2.5 shadow-sm transition-colors"
            to="/guideline-format"
          >
