    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="bg-gradient-to-b from-blue-50 to-white dark:from-gray-800 dark:to-gray-900 border-b border-gray-100 dark:border-gray-700">
        <div className="max-w-3xl mx-auto px-4 py-10 sm:py-14 text-center">
          {hubLink && (
            <Link to={resolveInternalLinkPath(hubLink.path)} className="inline-flex items-center gap-1.5 text-xs font-semibold text-blue-600 dark:text-blue-400 hover:underline mb-3">
        ...
        {isSubtitleCluster && (
          ...
          >
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300 mb-3">
              ...
              <Link to="/subtitle-tools" className="font-semibold text-blue-700 dark:text-blue-400 underline underline-offset-2">
            ...
            <Link
              to="/subtitle-tools"
              className="inline-flex items-center justify-center rounded-xl bg-blue-600 hover:bg-blue-600 text-white text-sm font-semibold px-4 py-2.5 transition-colors"
            >
          ...
          <div className="px-6 py-7 sm:px-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link
                ...
                className="inline-flex items-center justify-center rounded-xl bg-blue-600 hover:bg-blue-600 text-white font-semibold px-6 py-3 text-sm transition-colors"
              >
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {relatedTools.map((t) => (
              ...
              >
                <p className="font-semibold text-sm text-blue-600 dark:text-blue-400 group-hover:underline">{t.label}</p>
          ...
          {hubLink && (
            <div className="mt-3">
              ...
              >
                <p className="font-semibold text-sm text-blue-700 dark:text-blue-300">← Back to {hubLink.label}</p>
