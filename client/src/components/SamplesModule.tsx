    ...
    <div className="rounded-xl border border-blue-200/70 dark:border-blue-800/50 bg-blue-50/70 dark:bg-blue-950/20 px-4 py-4 sm:px-6 sm:py-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-medium text-gray-900 dark:text-gray-100">See real output samples</p>
        ...
        <Link
          to={samplesHref}
          onClick={handleClick}
          className="inline-flex items-center gap-1.5 rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium px-3 py-2 transition-colors"
        >
