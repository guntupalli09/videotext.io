...
export default function SerpTrustStrip() {
  return (
    <div className="border-b border-gray-100 dark:border-gray-800 bg-gray-50/80 dark:bg-gray-900/40">
      <p className="mx-auto max-w-4xl px-4 py-2.5 text-center text-xs text-gray-600 dark:text-gray-400 leading-relaxed">
