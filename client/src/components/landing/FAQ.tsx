    ...
    >
      ...
      >
        <div className="flex items-center justify-between gap-4 py-5 border-b border-gray-100 dark:border-white/[0.06] transition-colors duration-500">
          <span className="text-[15px] font-medium text-gray-800 dark:text-white/85 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors leading-snug">
            {q}
          </span>
