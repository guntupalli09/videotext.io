    ...
    >
      ...
      >
        <div className="flex items-center justify-between gap-4 py-5 border-b border-gray-100 dark:border-white/[0.06] transition-colors duration-500">
          <span className="text-[15px] font-semibold text-gray-800 dark:text-white/85 group-hover:text-violet-600 dark:group-hover:text-violet-400 transition-colors leading-snug">
            {q}
          </span>
          <div className="flex-shrink-0 w-7 h-7 rounded-full bg-gray-100 dark:bg-white/[0.05] flex items-center justify-center group-hover:bg-violet-100 dark:group-hover:bg-violet-500/15 transition-colors duration-200">
            {open
              ? <Minus className="w-3.5 h-3.5 text-violet-600 dark:text-violet-400" />
              : <Plus className="w-3.5 h-3.5 text-gray-500 dark:text-white/40 group-hover:text-violet-600 dark:group-hover:text-violet-400 transition-colors" />
            }
          </div>
        </div>
      </button>
  ...
  return (
    <section className="py-12 bg-white dark:bg-gray-950 transition-colors duration-500">
      <div className="max-w-3xl mx-auto px-6">
        ...
        >
          <p className="text-sm font-semibold text-violet-600 dark:text-violet-400 uppercase tracking-widest mb-3 transition-colors duration-500">
            Questions
          </p>
          ...
          <p className="text-lg text-gray-500 dark:text-white/40 transition-colors duration-500">
            ...
            <Link to="/feedback" className="text-violet-600 dark:text-violet-400 hover:underline underline-offset-2 transition-colors">
              Ask us anything →
            </Link>
          </p>
        </motion.div>
