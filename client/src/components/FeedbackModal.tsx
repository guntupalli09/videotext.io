            ...
            <AnimatePresence mode="wait">
              {sent ? (
                ...
                >
                  ...
                  <p className="text-lg font-medium text-gray-900 dark:text-white font-display">
                    Thank you!
                  </p>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="flex gap-2 pt-1">
                      <button
                        ...
                        className="flex-1 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 active:scale-[0.98] text-white text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-sm shadow-blue-200 dark:shadow-blue-900/30"
                      >
