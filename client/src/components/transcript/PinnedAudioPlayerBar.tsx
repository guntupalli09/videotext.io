    ...
    >
      <div className="pointer-events-auto flex w-full max-w-5xl items-center gap-2 sm:gap-4 rounded-xl border border-[#2a2840] bg-[#0a0a1a] px-3 py-3 sm:px-5 shadow-[0_-8px_40px_rgba(0,0,0,0.4)]">
        ...
        <span
          ...
          className="shrink-0 min-w-[2.75rem] font-mono-data text-xs tabular-nums text-white sm:text-sm"
        >
          0:00
        </span>
        <input
        ...
        <span
          ...
          className="shrink-0 min-w-[2.75rem] text-right font-mono-data text-xs tabular-nums text-white sm:text-sm"
        >
          0:00
        </span>
        <button
