            ...
            <div className="relative w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-blue-600 to-blue-700 rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg shrink-0">
              ...
              <div className="min-w-0">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-xs sm:text-sm">
                  <span className="font-mono-data">{(selectedFile.size / (1024 * 1024)).toFixed(2)} MB</span> • Ready to configure
                </p>
              </div>
            </div>
            {onRemove && (
          ...
          {uploadStatus === 'idle' && (
            <>
              <motion.div
                ...
                transition={{ duration: isDragging ? 0.3 : 2.5, repeat: isDragging ? 0 : Infinity, ease: 'easeOut' }}
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-2 sm:mb-3 text-xs sm:text-sm">
                or{' '}
                <label className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium cursor-pointer">
                  click to browse
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <div className="max-w-xs mx-auto">
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400 mt-1"><span className="font-mono-data">{progress}%</span> complete</p>
                </div>
              </div>
            </div>
          )}
          {uploadStatus === 'success' && (
            <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ type: 'tween', duration: 0.3, ease: 'easeOut' }} className="space-y-3">
              <div className="flex justify-center">
