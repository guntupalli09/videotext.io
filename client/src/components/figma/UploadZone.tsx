      ...
      >
        <div className="flex items-center justify-between gap-2 sm:gap-3">
          <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
            <div className="relative w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-violet-500 to-blue-500 rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg shrink-0">
              <Check className="w-6 h-6 sm:w-7 sm:h-7 text-white" />
              </div>
              <div className="min-w-0">
                {fromWorkflowLabel && (
                  <span className="text-xs font-medium text-violet-600 dark:text-violet-400 block mb-1">{fromWorkflowLabel}</span>
                )}
        ...
        <div className="relative p-4 sm:p-6 md:p-8 text-center min-w-0">
          {uploadStatus === 'idle' && (
            <>
              ...
              >
                <div className="relative w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-violet-500 to-blue-500 rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-2 sm:mb-3 text-xs sm:text-sm">
                or{' '}
                <label className="text-violet-600 dark:text-violet-400 hover:text-violet-700 dark:hover:text-violet-300 font-semibold cursor-pointer">
                  click to browse
          ...
          {uploadStatus === 'uploading' && (
            <div className="space-y-3">
              <div className="flex justify-center">
                <div className="relative w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-violet-500 to-blue-500 rounded-xl flex items-center justify-center shadow-lg">
