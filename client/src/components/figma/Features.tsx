        ...
        >
          ...
          <div className="relative p-6 sm:p-8">
            ...
            <div className="flex items-start justify-between mb-6">
              ...
              <span className={`text-[10px] font-medium px-2.5 py-1 rounded-full ${tool.badgeColor}`}>
                {tool.badge}
              </span>
            </div>

            {/* Copy */}
            <h3 className="text-xl font-medium text-gray-900 dark:text-white mb-1 font-display transition-colors duration-500">
              {tool.name}
            </h3>
            <p className={`text-sm font-medium mb-3 bg-gradient-to-r ${tool.gradient} bg-clip-text text-transparent`}>
              {tool.tagline}
            </p>
            ...
            {/* CTA */}
            <div className="flex items-center gap-1.5 text-sm font-medium text-blue-600 dark:text-blue-400 group-hover:gap-3 transition-all">
              {tool.cta}
    ...
    >
      <Link to={tool.href} onClick={() => trackEvent('tool_selected', { tool: tool.name, path: tool.href })}>
        ...
        >
          ...
          <h3 className="text-sm font-medium text-gray-900 dark:text-white mb-1.5 group-hover:text-blue-700 dark:group-hover:text-blue-400 transition-colors font-display">
            {tool.name}
          </h3>
          <p className="text-[13px] text-gray-500 dark:text-white/40 leading-relaxed mb-3 transition-colors duration-500">
            {tool.description}
          </p>
          <div className={`flex items-center gap-1 text-[12px] font-medium ${tool.accent} group-hover:gap-2 transition-all`}>
