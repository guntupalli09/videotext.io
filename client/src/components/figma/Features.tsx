        ...
        >
          ...
          <div className="relative p-4">
            ...
            <div className="flex items-start justify-between mb-6">
              <div
                className={`w-8 h-8 rounded-lg bg-gradient-to-br ${tool.gradient} flex items-center justify-center shadow-lg`}
              >
    ...
    >
      ...
      >
        <motion.div
          ...
          className="group h-full rounded-xl border border-gray-200 dark:border-white/[0.06] bg-white dark:bg-gray-900 p-4 hover:border-blue-300/60 dark:hover:border-blue-500/25 hover:shadow-lg transition-all duration-300"
        >
          <div
