        ...
        >
          ...
          <div className="relative px-5 py-4">
            ...
            <div className="flex items-start justify-between mb-3">
              <div
                className={`w-9 h-9 rounded-lg bg-gradient-to-br ${tool.gradient} flex items-center justify-center shadow-lg`}
              >
                <Icon className="h-5 w-5 text-white" />
              </div>
              <span
                className={`text-[10px] font-medium px-2.5 py-1 rounded-full ${tool.badgeColor}`}
              >
                {tool.badge}
              </span>
            </div>
            ...
            {/* Copy */}
            <h3 className="mb-1.5 text-sm font-medium leading-[1.3] text-gray-900 transition-colors duration-500 dark:text-white">
              {tool.name}
            </h3>
            <p
              className={`text-sm font-medium mb-3 bg-gradient-to-r ${tool.gradient} bg-clip-text text-transparent`}
            >
              {tool.tagline}
            </p>
            <p className="mb-0 text-[13px] font-normal leading-[1.6] text-gray-500 transition-colors duration-500 dark:text-white/45">
              {tool.description}
            </p>
            ...
            <div className="rounded-xl border border-gray-100 dark:border-white/[0.05] bg-gray-50 dark:bg-white/[0.02] p-3.5 mb-6 transition-colors duration-500">
              <div className="flex items-center gap-1.5 mb-2.5">
                ...
                <span className="text-[9px] text-emerald-600 dark:text-emerald-400/80 font-medium uppercase tracking-wide">
                  Sample output
                </span>
              </div>
            ...
            {/* CTA */}
            <div className="mt-2.5 block text-xs font-medium text-gray-500 transition-colors duration-150 hover:text-gray-900 dark:text-white/45 dark:hover:text-white">
              {tool.cta}
    ...
    >
      ...
      >
        <motion.div
          ...
          className="group h-full rounded-xl border border-gray-200 dark:border-white/[0.06] bg-white dark:bg-gray-900 px-5 py-4 hover:border-blue-300/60 dark:hover:border-blue-500/25 hover:shadow-lg transition-all duration-300"
        >
          <div
            className={`w-9 h-9 rounded-lg bg-gradient-to-br ${tool.gradient} flex items-center justify-center mb-3 shadow-md`}
          >
            <Icon className="h-5 w-5 text-white" />
          </div>
          <h3 className="mb-1.5 text-sm font-medium leading-[1.3] text-gray-900 transition-colors group-hover:text-blue-700 dark:text-white dark:group-hover:text-blue-400">
            {tool.name}
          </h3>
          <p className="mb-0 text-[13px] font-normal leading-[1.6] text-gray-500 transition-colors duration-500 dark:text-white/40">
            {tool.description}
          </p>
          <div className="mt-2.5 block text-[12px] font-medium text-gray-500 transition-colors duration-150 hover:text-gray-900 dark:text-white/45 dark:hover:text-white">
        ...
        >
          <Link to="/video-to-transcript">
            <motion.span
              ...
              className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white px-7 py-3.5 rounded-xl font-medium text-sm shadow-lg shadow-blue-500/20 hover:shadow-xl hover:shadow-blue-500/30 transition-all"
            >
