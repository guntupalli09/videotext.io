    ...
    <div className="space-y-4 sm:space-y-6 min-w-0 w-full">
      ...
      >
        ...
        {onProcessAnother && (
          <button
            ...
            className="shrink-0 inline-flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-medium text-blue-700 dark:text-blue-200 bg-blue-100/90 dark:bg-blue-900/40 border border-blue-300/70 dark:border-blue-600/60 hover:bg-blue-200 dark:hover:bg-blue-800/50 shadow-sm transition-colors whitespace-nowrap"
      ...
      {onDownload && (
        <motion.button
          ...
          whileTap={{ scale: 0.99 }}
          onClick={onDownload}
          className="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-xl shadow-sm hover:shadow-md transition-all flex items-center justify-center gap-2 text-sm"
        >
      ...
      {onGenerateSubtitles != null && (
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col gap-2">
          <button
            ...
            className="w-full py-3 sm:py-3.5 bg-white dark:bg-gray-800 border-2 border-blue-500 dark:border-blue-500 text-blue-600 dark:text-blue-400 font-medium rounded-xl hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all flex items-center justify-center gap-2 text-sm sm:text-base"
          >
