  ...
  return (
    <div className="w-full max-w-xl mx-auto">
      ...
      <div
        ...
        className={`
          relative cursor-pointer rounded-xl border-2 border-dashed px-4 py-4
          flex flex-col items-center gap-3 transition-all duration-200 select-none
          ${
            dragging
              ? "border-blue-300 bg-blue-600/18 shadow-[0_0_0_1px_rgba(37,99,235,0.45),0_0_34px_rgba(37,99,235,0.34)] scale-[1.015]"
              : "border-blue-300/45 bg-gradient-to-b from-blue-600/18 to-blue-400/12 shadow-[0_0_0_1px_rgba(37,99,235,0.28),0_12px_44px_rgba(15,23,42,0.45)] hover:border-blue-300/70 hover:from-blue-600/25 hover:to-blue-400/16 hover:shadow-[0_0_0_1px_rgba(37,99,235,0.45),0_0_38px_rgba(37,99,235,0.25)]"
          }
        `}
      >
        {/* Icon */}
      ...
      <div className="grid grid-cols-1 gap-2">
        <Link
          to="/guideline-format"
          className="group flex flex-col gap-2.5 rounded-xl border border-blue-300/30 bg-gradient-to-b from-blue-600/14 to-blue-400/12 shadow-[0_0_0_1px_rgba(37,99,235,0.2),0_10px_30px_rgba(15,23,42,0.35)] hover:border-blue-300/60 hover:from-blue-600/22 hover:to-blue-400/16 hover:shadow-[0_0_0_1px_rgba(37,99,235,0.42),0_0_30px_rgba(37,99,235,0.2)] px-4 py-3.5 transition-all duration-200"
        >
              ...
              <span className="flex items-center gap-2">
                <span className="flex items-center -space-x-2">
                  ...
                  <span className="w-[22px] h-[22px] rounded-full border-2 border-gray-950 bg-blue-600/25 flex items-center justify-center">
                    <span className="text-[7px] font-medium text-blue-300">
                      12K+
                    </span>
                  </span>
                </span>
