...
export function HowItWorks() {
  return (
    <section
      id="how-it-works"
      className="relative py-20 px-6 bg-gray-950 transition-colors duration-500 overflow-hidden"
    >
      {/* Background dot grid */}
      <div
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        {/* Steps */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6 relative mb-10">
              ...
              >
                ...
                <div className="relative z-10 mb-4">
                  <motion.div
                    ...
                    className={`relative w-12 h-12 rounded-xl bg-gradient-to-br ${step.color} flex items-center justify-center shadow-xl ${step.shadowColor}`}
                  >
                  ...
                  <div className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-gray-950 border border-gray-700 flex items-center justify-center">
                    <span className="text-[11px] font-medium uppercase tracking-[0.06em] text-white/60">
                      {index + 1}
                    </span>
                  </div>
                </div>
                ...
                <h3 className="mt-3.5 mb-1.5 text-base font-medium text-white">
                  {step.title}
                </h3>
                <p className="max-w-[240px] text-[13px] font-normal leading-[1.6] text-white/45">
                  {step.description}
                </p>
              </motion.div>
            );
