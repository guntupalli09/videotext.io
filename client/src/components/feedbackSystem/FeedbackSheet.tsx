...
export function SubmitButton({
  ...
  return (
    <button
      ...
      className="w-full py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 active:scale-[0.98] text-white text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-sm shadow-blue-200 dark:shadow-blue-900/30"
    >
...
export function ThankYouState({ message = "Thanks! Your feedback shapes what we build next." }: { message?: string }) {
  return (
    <div className="py-6 text-center">
      ...
      <p className="text-base font-medium text-gray-900 dark:text-white font-display">Thank you!</p>
