    ...
    <div className="min-h-screen bg-gray-50 py-12 sm:py-16">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-gray max-w-none space-y-6 text-sm text-gray-700">
          ...
          <section>
            <h2 className="text-lg font-medium text-gray-900 mb-2">Use of the service</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-gray-900 mb-2">Privacy and data</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-gray-900 mb-2">Billing and subscriptions</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-gray-900 mb-2">Disclaimer</h2>
            <p>
