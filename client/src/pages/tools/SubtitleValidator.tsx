  ...
  return (
    <FreeToolLayout
      ...
      faqs={[
        ...
        { q: 'What is the maximum line length for subtitles?', a: 'Netflix TTSC requires no more than 42 characters per line (CPL). BBC specifies 37 characters. YouTube does not publish an official CPL limit. This tool flags lines over 42 characters as warnings.' },
