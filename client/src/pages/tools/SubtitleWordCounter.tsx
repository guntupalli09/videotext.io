  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        <button onClick={handleCount} className="w-full py-3 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm transition-colors">Count Words & Stats</button>
