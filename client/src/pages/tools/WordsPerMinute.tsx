  ...
  return (
    <FreeToolLayout
      ...
      faqs={[
        ...
        { q: 'Why does speaking rate matter for subtitles?', a: 'Your speaking rate determines subtitle reading difficulty. Speaking at 180 WPM generates subtitles that may approach or exceed Netflix TTSC\'s 20 CPS adult limit. Slower speech produces more readable, broadcast-compliant subtitles.' },
