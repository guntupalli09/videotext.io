              ...
              <div className="overflow-hidden rounded-xl border border-gray-200 dark:border-gray-600">
                <table className="w-full text-sm">
                  <thead className="bg-gray-50 dark:bg-gray-800">
                    <tr>
                      <th className="text-left px-4 py-2 text-xs font-medium text-gray-500 uppercase tracking-wide">Content type</th>
                      <th className="text-left px-4 py-2 text-xs font-medium text-gray-500 uppercase tracking-wide">Typical WPM</th>
                      <th className="text-left px-4 py-2 text-xs font-medium text-gray-500 uppercase tracking-wide">CPS equivalent</th>
                    </tr>
                  </thead>
      ...
      <div className="space-y-5">
          ...
          <div className="space-y-3">
            <div>
              <div className="flex justify-between mb-1.5">
                <label className="text-sm font-medium text-gray-700 dark:text-gray-300">Paste the text you spoke</label>
            ...
            <div>
              <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">How long did it take?</p>
        ...
        {result && info && (
          <div className="rounded-xl bg-gradient-to-br from-blue-600 to-blue-700 p-6 text-center text-white">
            <p className="text-xs font-medium uppercase tracking-widest text-blue-200 mb-1">Your speaking rate</p>
            <p className="text-6xl font-display font-medium">{result}</p>
