...
const TOOLS = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/tools/subtitle-character-checker', label: 'Character Limit Checker', desc: 'Verify line lengths against Netflix TTSC (42 CPL), BBC (37), or a wide 80-char preset', keywords: 'netflix subtitle character limit, subtitle line length' },
      ...
      <div className="max-w-4xl mx-auto px-4 py-10 space-y-10">
          ...
          <section key={group.category}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {group.items.map((tool) => (
                ...
                >
                  <p className="font-semibold text-sm text-blue-700 dark:text-blue-400 group-hover:underline">{tool.label}</p>
        ...
        <section className="rounded-xl bg-blue-600 px-6 py-10 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <Link to="/video-to-transcript" className="inline-block rounded-lg border border-white/50 text-white font-semibold px-6 py-3 text-sm hover:bg-blue-700 transition-colors">
