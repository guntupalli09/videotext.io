    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="max-w-4xl mx-auto px-4 py-10 space-y-10">
          ...
          <section key={group.category}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {group.items.map((tool) => (
                ...
                >
                  <p className="font-medium text-sm text-blue-700 dark:text-blue-400 group-hover:underline">{tool.label}</p>
        ...
        <section className="rounded-xl bg-blue-600 px-6 py-10 text-center text-white">
          <p className="text-xs font-medium uppercase tracking-widest text-blue-200 mb-2">Ready for AI-powered subtitles?</p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link to="/video-to-subtitles" className="inline-block rounded-lg bg-white text-blue-700 font-medium px-6 py-3 text-sm hover:bg-blue-50 transition-colors">
              Generate subtitles free
            </Link>
            <Link to="/video-to-transcript" className="inline-block rounded-lg border border-white/50 text-white font-medium px-6 py-3 text-sm hover:bg-blue-700 transition-colors">
        ...
        <section className="prose prose-sm dark:prose-invert max-w-none">
          ...
          <p className="text-gray-600 dark:text-gray-400 leading-relaxed mt-3">
            When you need more — like AI-generated subtitles from video, translation to 70+ languages, or batch processing hundreds of videos — <Link to="/video-to-subtitles" className="text-blue-600 hover:underline">VideoText's paid tools</Link> are right here.
          </p>
        </section>
      </div>
    </div>
