  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        <button onClick={handleConvert} className="w-full py-3 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm transition-colors">
          Extract Text
        </button>
        ...
        {output && (
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              <button onClick={() => navigator.clipboard.writeText(output)} className="flex-1 py-2.5 rounded-xl border border-blue-300 dark:border-blue-600 text-blue-700 dark:text-blue-300 font-semibold text-sm hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors">Copy all</button>
              <button
                onClick={() =>
                  downloadText(
                    output,
