    ...
    >
      <div className="space-y-5">
          ...
          <div className="space-y-4">
            <div className="flex gap-4 items-center">
              <div className="flex-1">
                <label className="text-xs font-medium text-gray-600 dark:text-gray-400 block mb-1.5">Width (px)</label>
              ...
              <div className="flex-1">
                <label className="text-xs font-medium text-gray-600 dark:text-gray-400 block mb-1.5">Height (px)</label>
            ...
            {detectedRatio && (
              <div className="rounded-xl bg-blue-50 dark:bg-blue-900/20 p-5 text-center">
                <p className="text-4xl font-display font-medium text-blue-700 dark:text-blue-300">{detectedRatio}</p>
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="flex gap-3 mt-3 items-end">
                ...
                <span className="text-gray-400 font-medium pb-2">:</span>
            ...
            <div>
              <p className="text-xs font-medium text-gray-600 dark:text-gray-400 mb-2">I know the…</p>
            ...
            {calcResult && (
              <div className="rounded-xl bg-blue-50 dark:bg-blue-900/20 p-5 text-center">
                ...
                <p className="text-4xl font-display font-medium text-blue-700 dark:text-blue-300 mt-1">{calcResult}px</p>
        ...
        <div className="rounded-xl border border-gray-200 dark:border-gray-600 overflow-hidden">
          <p className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide px-4 py-2 bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-600">Common aspect ratios</p>
          <div className="divide-y divide-gray-100 dark:divide-gray-700">
            {COMMON_RATIOS.map((r) => (
              <div key={r.ratio} className="flex justify-between items-center px-4 py-2 text-sm">
                <span className="font-mono font-medium text-blue-700 dark:text-blue-400">{r.ratio}</span>
