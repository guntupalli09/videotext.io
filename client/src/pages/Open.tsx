      ...
      <div className="max-w-4xl mx-auto px-6 pb-24 space-y-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {STATS.map(({ icon: Icon, label, value, note }) => (
              <div key={label} className="bg-gray-50 dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-white/[0.06] p-6 transition-colors duration-500">
                <div className="w-10 h-10 rounded-lg bg-violet-100 dark:bg-violet-500/15 flex items-center justify-center mb-4">
            ...
            <div className="divide-y divide-gray-100 dark:divide-white/[0.03] bg-white dark:bg-gray-900/50">
              {ACCURACY_DATA.map(({ condition, accuracy }) => (
                <div key={condition} className="grid grid-cols-3 px-5 py-3.5 items-center">
                  ...
                  <span className="text-sm font-bold text-violet-600 dark:text-violet-400 text-right">{accuracy}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <section>
          ...
          <div className="flex flex-wrap gap-3">
            <Link to="/compare" className="text-sm font-medium text-violet-600 dark:text-violet-400 underline underline-offset-2 hover:text-violet-700">
              VideoText vs Descript, Otter, Trint →
            </Link>
            <Link to="/descript-alternative" className="text-sm font-medium text-violet-600 dark:text-violet-400 underline underline-offset-2 hover:text-violet-700">
              Descript alternative →
            </Link>
            <Link to="/otter-ai-alternative" className="text-sm font-medium text-violet-600 dark:text-violet-400 underline underline-offset-2 hover:text-violet-700">
        ...
        <section>
          ...
          <div className="flex flex-wrap gap-3 text-sm">
            <Link to="/transcription-benchmark" className="text-violet-600 dark:text-violet-400 underline underline-offset-2 hover:text-violet-700">Transcription benchmark →</Link>
            <Link to="/accuracy-test" className="text-violet-600 dark:text-violet-400 underline underline-offset-2 hover:text-violet-700">Accuracy test →</Link>
            <Link to="/fastest-transcription-software" className="text-violet-600 dark:text-violet-400 underline underline-offset-2 hover:text-violet-700">Fastest transcription software →</Link>
            <Link to="/fastest-transcription-tool" className="text-violet-600 dark:text-violet-400 underline underline-offset-2 hover:text-violet-700">Fastest transcription tool →</Link>
            <Link to="/best-transcription-tool" className="text-violet-600 dark:text-violet-400 underline underline-offset-2 hover:text-violet-700">Best transcription tool →</Link>
            <Link to="/ai-transcription-tools" className="text-violet-600 dark:text-violet-400 underline underline-offset-2 hover:text-violet-700">AI transcription tools →</Link>
            <Link to="/ai-transcription-workflow" className="text-violet-600 dark:text-violet-400 underline underline-offset-2 hover:text-violet-700">AI transcription workflow →</Link>
            <Link to="/videotext-vs-turboscribe" className="text-violet-600 dark:text-violet-400 underline underline-offset-2 hover:text-violet-700">VideoText vs TurboScribe →</Link>
            <Link to="/videotext-vs-rev" className="text-violet-600 dark:text-violet-400 underline underline-offset-2 hover:text-violet-700">VideoText vs Rev →</Link>
            <Link to="/best-transcription-tool" className="text-violet-600 dark:text-violet-400 underline underline-offset-2 hover:text-violet-700">Best transcription tool →</Link>
            <Link to="/ai-transcription-tools" className="text-violet-600 dark:text-violet-400 underline underline-offset-2 hover:text-violet-700">AI transcription tools →</Link>
          </div>
        </section>
