...
const ENTRIES: ChangelogEntry[] = [
  ...
  },
  {
    ...
    tag: 'improvement',
    items: [
      'Design system overhaul: Geist font, consistent surface-card tokens, unified button and input styles across all pages.',
          ...
          {ENTRIES.map((entry) => (
            <div key={entry.version} className="relative pl-6 border-l-2 border-gray-200 dark:border-gray-700">
              ...
              <div className="flex flex-wrap items-center gap-3 mb-3">
                ...
                <span className={`text-xs font-medium px-2 py-0.5 rounded-full ${TAG_STYLES[entry.tag]}`}>
