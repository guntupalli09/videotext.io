...
export default function VideoToTranscript(
  ...
  const { faq = [], seoDeepContent, defaultInputMode = "file" } = props;
    ...
    <>
      <ToolLayout {...layoutProps}>
          ...
          <div className="space-y-4">
            ...
            {inputMode === "youtube" && (
              <div className="space-y-4">
                ...
                <div className="rounded-xl bg-gray-50/90 dark:bg-gray-900/40 border border-gray-200 dark:border-gray-700/50 p-3 space-y-1">
                  <h4 className="text-[11px] font-medium uppercase tracking-[0.06em] text-gray-500 dark:text-gray-400">
                    Options
                  </h4>
                  <div className="divide-y divide-gray-200/70 dark:divide-gray-800">
                    {/* AI Summary — Pro only */}
                    {isPaidPlan ? (
                      <label className="flex min-h-9 items-center gap-2 py-1.5 cursor-pointer select-none">
                        <input
                          type="checkbox"
                      ...
                      <div className="flex min-h-9 items-center justify-between py-1.5 opacity-60">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full rounded-lg border border-gray-300 bg-white px-3 py-1.5 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-800 dark:text-white"
                      >
              ...
              <div className="space-y-1.5 max-h-64 overflow-y-auto">
                {batchFiles.map((f, i) => (
                  ...
                  >
                    ...
                    <span className="text-xs text-gray-400 shrink-0 font-mono-data">
        ...
        {isBatchMode && status === "processing" && batchInfo && (
          <div className="rounded-xl border border-blue-200/80 dark:border-blue-800/50 bg-gradient-to-br from-blue-50/90 via-white to-blue-50/50 dark:from-blue-950/40 dark:via-gray-900/80 dark:to-blue-950/20 p-6 sm:p-8 space-y-6 shadow-lg shadow-blue-500/10">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
              <div className="flex gap-4">
                <div className="shrink-0 flex h-11 w-11 sm:h-12 sm:w-12 items-center justify-center rounded-xl bg-gradient-to-br from-blue-600 to-blue-600 text-white shadow-md">
            ...
            >
                ...
                return (
                  <div className="flex flex-wrap items-center gap-2 px-1">
                    {pills.map((label) => (
                      <span
                        key={label}
                        className="inline-flex items-center px-2.5 py-1 rounded-full bg-gray-100 dark:bg-gray-800 text-xs font-mono-data text-gray-500 dark:text-gray-400"
                      >
                        {label}
                      </span>
                    ))}
              ...
              <div className="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(380px,500px)] xl:grid-cols-[minmax(0,1fr)_540px] items-start">
                <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm overflow-hidden flex flex-col min-h-[min(62vh,640px)]">
                  <div
                    className="flex h-10 shrink-0 items-end gap-1 border-b border-gray-100 bg-gray-50/90 px-2 dark:border-gray-800 dark:bg-gray-950/50"
                    role="tablist"
                  ...
                  {leftWorkspaceTab === "speakers" ? (
                    ...
                    <div className="p-4 flex flex-col flex-1 min-h-0">
                      ...
                      <div className="mb-3 flex flex-wrap items-center gap-2">
                        <div className="flex-1 min-w-[160px] relative">
                          ...
                          <input
                            ...
                            className="h-8 w-full rounded-lg border-0 bg-black/[0.04] pl-9 pr-4 text-sm text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-600 dark:bg-white/[0.06] dark:text-white"
                          />
                        </div>
                        {isPaidPlan && (
                          <button
                            ...
                            className="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-gray-300 bg-gray-100 text-gray-700 transition-colors hover:bg-gray-200 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
                          >
                            <PenLine
                              className="h-4 w-4"
                              aria-label={
                      ...
                      <div
                        ...
                        className="flex-1 min-h-0 overflow-y-auto rounded-xl border border-gray-200/90 bg-white px-5 py-5 text-sm leading-[1.65] text-[#111] antialiased shadow-[inset_0_1px_0_0_rgba(15,23,42,0.04)] selection:bg-blue-100 selection:text-[#1d1d1f]"
                      >
                                ...
                                if (item.markerTime != null) {
                                  ...
                                  rendered.push(
                                    <div
                                      ...
                                      className="mt-5 first:mt-0 mb-1.5 text-[13px] font-medium text-blue-600 dark:text-blue-400"
                                    >
                                  ...
                                  return (
                                    <div key={gi}>
                                      {hasSpeakers && vg.speaker && (
                                        <div className="mb-1 flex items-center justify-between border-t border-black/[0.06] pt-3 font-mono text-[11px] uppercase text-gray-500 first:border-t-0 first:pt-0">
                                          {vg.speaker}
                                          {showSpeakerHeaders && (
                                            <span className="ml-auto font-mono text-[11px] font-normal text-gray-400 dark:text-gray-500">
                ...
                <aside className="space-y-3 lg:sticky lg:top-16 self-start min-w-0">
                  {(() => {
                    ...
                    const summaryCls =
                      "flex cursor-pointer list-none items-center justify-between px-3 py-2 text-sm font-medium text-gray-900 dark:text-gray-100 [&::-webkit-details-marker]:hidden";
                    return (
                      <>
                        <div
                          id="exports-panel"
                          className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-3 shadow-sm"
                        >
                                    ...
                                    (format) => {
                                      ...
                                      return (
                                        <button
                                          ...
                                          disabled={!canClick}
                                          className="rounded-lg border border-blue-400/70 bg-blue-600 px-3 py-2 font-mono text-xs font-medium tracking-wide text-white transition-colors hover:bg-blue-600 dark:border-blue-500/70 dark:bg-blue-700 dark:hover:bg-blue-600"
                              ...
                              <div>
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                  <button
                                    type="button"
                                    onClick={handleExportSrt}
                                    className="rounded-lg border border-gray-200 dark:border-gray-700 px-3 py-2 font-mono text-xs font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
                                  >
                                    SRT (Original)
                                  </button>
                                  {translateEnabled &&
                                  ...
                                  translatedSegments ? (
                                    ...
                                    <button
                                      type="button"
                                      disabled
                                      className="rounded-lg border border-gray-200 dark:border-gray-700 px-3 py-2 font-mono text-xs font-medium text-gray-400 bg-gray-50 dark:bg-gray-800/50 cursor-not-allowed"
                                    >
                                      SRT (Translated)
                                    </button>
                                  )}
      ...
      {hasDeepContent && (
        ...
        >
          ...
          {seoDeepContent?.proofPoints?.length ? (
            <div>
              <div className="mb-8">
                <p className="text-xs font-medium uppercase tracking-widest text-blue-600 dark:text-blue-400 mb-2">
                  By the numbers
                </p>
                <h2 className="text-2xl sm:text-3xl font-medium text-gray-900 dark:text-gray-100">
                  Proof, not promises
            ...
            <div>
              ...
              <div className="grid gap-4 md:grid-cols-3">
                {seoDeepContent.workflowSteps.map((step, idx) => (
                  ...
                  >
                    <span
                      className="mb-4 flex h-8 w-8 items-center justify-center rounded-full bg-blue-600 text-white text-sm font-medium"
                      aria-hidden
                    >
                      {idx + 1}
                    </span>
                ...
                <table className="min-w-full text-sm">
                  <thead>
                    <tr className="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/80">
                      <th className="px-5 py-4 text-left text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-gray-400 w-1/3">
                        Feature
                      </th>
                      <th className="px-5 py-4 text-left text-xs font-medium uppercase tracking-wide text-blue-600 dark:text-blue-400 w-1/3">
                        VideoText
                      </th>
                      <th className="px-5 py-4 text-left text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-gray-400 w-1/3">
                  ...
                  <tbody className="divide-y divide-gray-100 dark:divide-gray-800 bg-white dark:bg-gray-950/20">
                    {seoDeepContent.comparisonRows.map((row, idx) => (
                      ...
                      >
                        <td className="px-5 py-4 text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-gray-400">
                          {row.feature}
                        </td>
            ...
            <div>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {seoDeepContent.useCases.map((useCase, idx) => (
                  ...
                  >
                    <span
                      className="shrink-0 flex h-8 w-8 items-center justify-center rounded-xl bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-sm font-medium"
                      aria-hidden
                    >
                      {idx + 1}
                    </span>
