          ...
          <tbody>
            {toolPerf.map((t) => (
              <tr key={t.toolType} className="border-b border-zinc-800/50 hover:bg-zinc-800/20 transition-colors">
                ...
                <td className="py-2.5 px-4 text-right text-white tabular-nums font-medium">{t.count.toLocaleString()}</td>
                ...
                <td className="py-2.5 px-4 text-right tabular-nums">
                  {t.totalMinutes != null ? (
                    <span className="text-blue-400 font-medium">{t.totalMinutes.toLocaleString()} min</span>
                  ) : '—'}
                </td>
              </tr>
            ))}
