...
const TOOL_GUIDES: ToolGuide[] = [
  ...
  },
  {
    ...
    shortDesc: 'Download the video, then upload the file to get a full transcript. Works with any public YouTube video you can save locally.',
    howTo: [
      'Download the video file from YouTube (or export it from YouTube Studio).',
      'Upload the file on the YouTube → Transcript page (same Video to Transcript engine).',
      'Optionally set the spoken language — auto-detect works but manual improves accuracy for non-English content.',
      'Click Generate Transcript. Transcription starts after the upload finishes.',
    ...
    expected: [
      { label: 'Input', detail: 'A downloaded video or audio file (MP4, MOV, WebM, MP3, and similar). Private or age-restricted YouTube links cannot be pasted.' },
    ...
    features: [
      'Upload a downloaded YouTube file — URL paste is temporarily disabled.',
    ...
    <div className="min-h-screen bg-gray-50 py-12 sm:py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-gray-700 mb-6">
          ...
          what inputs we expect, and what you get. Most tools accept file uploads (MP4, MOV, AVI, WebM). For YouTube videos, download the file first, then upload it. For billing and limits, see{' '}
        ...
        <div className="mb-10 grid grid-cols-1 sm:grid-cols-2 gap-4">
          {[
            ...
            { who: 'YouTubers', want: 'Upload a downloaded YouTube file, get transcript + AI chapters + multi-language subtitles.', path: '#youtube-transcript' },
