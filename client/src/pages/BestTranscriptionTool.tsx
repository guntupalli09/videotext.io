  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <section className="mb-10 space-y-4">
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">What is the fastest transcription tool for long videos?</h2>
      ...
      <section className="mb-10 space-y-4">
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">Fastest Way to Transcribe Video Content</h2>
        <ul className="list-disc space-y-2 pl-6 text-gray-700 dark:text-gray-300">
      ...
      <section className="mb-10 space-y-4 overflow-x-auto">
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">Fast Transcription Tools Compared (VideoText vs Otter vs Descript vs Rev vs Sonix)</h2>
        <table className="min-w-full divide-y divide-gray-200 text-left dark:divide-gray-700">
          <thead>
            <tr>
              <th className="px-3 py-2 font-semibold">Tool</th><th className="px-3 py-2 font-semibold">Speed</th><th className="px-3 py-2 font-semibold">Best for</th><th className="px-3 py-2 font-semibold">Output</th>
            </tr>
          </thead>
      ...
      <section className="space-y-4">
        ...
        <div><h3 className="font-semibold">What is the fastest way to transcribe long videos?</h3><p className="text-gray-700 dark:text-gray-300">Using tools optimized for batch processing and structured outputs reduces time significantly.</p></div>
        <div><h3 className="font-semibold">Can I generate transcript and subtitles together?</h3><p className="text-gray-700 dark:text-gray-300">Yes. Some tools provide transcript + subtitle outputs in a single workflow.</p></div>
        <div><h3 className="font-semibold">What is the best transcription tool for YouTube videos?</h3><p className="text-gray-700 dark:text-gray-300">Tools that process long videos quickly and generate structured outputs are best suited.</p></div>
        <div><h3 className="font-semibold">How long does it take to transcribe a 2-hour video?</h3><p className="text-gray-700 dark:text-gray-300">With optimized tools, it can take just a few minutes instead of hours.</p></div>
        <div><h3 className="font-semibold">Do I need multiple tools for transcription and subtitles?</h3><p className="text-gray-700 dark:text-gray-300">No. Modern workflows combine transcript, subtitles, and summary generation in one pass.</p></div>
      </section>
    </div>
  )
}
