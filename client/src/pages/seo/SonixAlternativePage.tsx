...
const COMPARE_ROWS = [
  { label: 'Starting price', videotext: 'Free / $10 Creator Pro', competitor: '$22/month or $10/hour' },
...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Yes. Sonix costs $22/month for the Standard plan (roughly 100 minutes included) and charges $0.10 per additional minute. VideoText Creator Pro is $10/month flat. For most users — podcasters, YouTubers, course creators — VideoText is significantly cheaper with no per-minute billing surprises.',
  },
  {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors duration-500">
      ...
      <section className="relative py-20 sm:py-28 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-purple-50 dark:bg-purple-500/10 border border-purple-200/60 dark:border-purple-500/20 mb-6">
            <span className="text-[12px] font-semibold text-purple-600 dark:text-purple-400 uppercase tracking-wide">Sonix Alternative</span>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-24 space-y-16">
        ...
        <section>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Why people look for a Sonix alternative</h2>
        ...
        {/* Comparison table */}
        <section>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">VideoText vs Sonix — feature comparison</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">When Sonix is still the right choice</h2>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-3 gap-5">
          {[
            { icon: DollarSign, title: 'No per-minute billing', body: 'Sonix charges $0.10/minute over your plan. VideoText\'s Creator Pro is a flat $10/month — no surprise invoices for longer podcasts or webinars.' },
        ...
        <section className="bg-gradient-to-br from-purple-600 via-violet-600 to-indigo-700 rounded-3xl p-8 sm:p-12 text-white text-center">
          <h2 className="text-2xl sm:text-3xl font-bold mb-3">Switch from Sonix — start free today</h2>
