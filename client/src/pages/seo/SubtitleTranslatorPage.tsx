...
const FAQ = [
  { q: 'What languages are supported?', a: '70+ languages including Arabic, Hindi, Spanish, French, German, Chinese, Japanese. Pick target language when translating.' },
...
export default function SubtitleTranslatorPage() {
  return (
    <TranslateSubtitles
      ...
      seoIntro="Translate SRT or VTT subtitles to 70+ languages. Upload, pick target language, download. Timestamps stay intact."
      faq={FAQ}
    />
  )
}
