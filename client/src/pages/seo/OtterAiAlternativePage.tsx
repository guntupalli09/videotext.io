...
const COMPARE_ROWS = [
  { label: 'Starting price', videotext: 'Free / $40/mo Pro', competitor: 'Free (300 min/mo) / $16.99/mo Pro' },
      ...
      <section className="relative py-20 sm:py-28 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-50 dark:bg-blue-600/10 border border-blue-200/60 dark:border-blue-500/20 mb-6">
            <span className="text-[12px] font-medium text-blue-600 dark:text-blue-400 uppercase tracking-wide">Otter.ai Alternative</span>
          </div>
