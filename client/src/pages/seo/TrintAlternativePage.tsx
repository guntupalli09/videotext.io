      ...
      <section className="relative py-20 sm:py-28 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-violet-50 dark:bg-violet-500/10 border border-violet-200/60 dark:border-violet-500/20 mb-6">
            <span className="text-[12px] font-semibold text-violet-600 dark:text-violet-400 uppercase tracking-wide">Trint Alternative</span>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-24 space-y-16">
        ...
        <section className="rounded-2xl border border-gray-200 dark:border-white/[0.06] p-6 bg-white dark:bg-gray-900/40">
          ...
          <div className="flex flex-wrap gap-3 text-sm">
            <Link to="/rev-alternative" className="text-violet-600 dark:text-violet-400 hover:underline">Rev alternative</Link>
