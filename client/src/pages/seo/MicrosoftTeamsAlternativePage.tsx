...
const COMPARE_ROWS = [
  { label: 'Starting price', videotext: 'Free / $10/mo', competitor: '$30/user/mo (Copilot add-on)' },
      ...
      <section className="relative py-20 sm:py-28 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-purple-50 dark:bg-purple-500/10 border border-purple-200/60 dark:border-purple-500/20 mb-6">
            <span className="text-[12px] font-semibold text-purple-600 dark:text-purple-400 uppercase tracking-wide">Microsoft Teams Alternative</span>
          </div>
