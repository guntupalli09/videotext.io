...
function Cell({ val, isUs = false }: { val: boolean | string; isUs?: boolean }) {
  if (typeof val === 'string') return <span className={`text-sm font-medium ${isUs ? 'text-blue-600 dark:text-blue-400' : 'text-gray-600 dark:text-gray-300'}`}>{val}</span>
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors duration-500">
      <section className="relative py-20 sm:py-28 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <Link to="/video-to-transcript?source=fireflies-alternative" className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white px-7 py-3.5 rounded-xl font-medium text-[15px] shadow-lg shadow-blue-500/25">
      ...
      <div className="max-w-4xl mx-auto px-6 pb-24 space-y-14">
        ...
        <section className="bg-gradient-to-br from-blue-600 via-blue-600 to-blue-700 rounded-xl p-8 sm:p-12 text-white text-center">
          ...
          <Link to="/video-to-transcript?source=fireflies-alternative" className="inline-flex items-center gap-2 bg-white text-blue-700 px-8 py-3.5 rounded-xl font-medium text-[15px] shadow-lg hover:shadow-xl transition-all">
