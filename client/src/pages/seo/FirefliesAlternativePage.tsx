...
function Cell({ val, isUs = false }: { val: boolean | string; isUs?: boolean }) {
  if (typeof val === 'string') return <span className={`text-sm font-semibold ${isUs ? 'text-blue-600 dark:text-blue-400' : 'text-gray-600 dark:text-gray-300'}`}>{val}</span>
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors duration-500">
      <section className="relative py-20 sm:py-28 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <h1 className="text-4xl sm:text-5xl font-medium text-gray-900 dark:text-white mb-5 leading-tight">Fireflies alternative for teams that want post-meeting outputs without a bot in the call</h1>
          ...
          <Link to="/video-to-transcript?source=fireflies-alternative" className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white px-7 py-3.5 rounded-xl font-semibold text-[15px] shadow-lg shadow-blue-500/25">
      ...
      <div className="max-w-4xl mx-auto px-6 pb-24 space-y-14">
        <section className="rounded-xl border border-gray-200 dark:border-white/[0.06] p-6 bg-white dark:bg-gray-900/40">
          <h2 className="text-2xl font-medium text-gray-900 dark:text-white mb-4">Switch criteria: Fireflies vs VideoText</h2>
          <div className="grid sm:grid-cols-2 gap-5 text-sm">
            <div>
              <h3 className="font-medium text-gray-900 dark:text-white mb-2">Stay with Fireflies if you need:</h3>
        ...
        <section>
          <h2 className="text-2xl font-medium text-gray-900 dark:text-white mb-4">Who Fireflies is good for vs who should switch</h2>
        ...
        <section>
          <h2 className="text-2xl font-medium text-gray-900 dark:text-white mb-4">Bot-first meeting notes vs file-first deliverables</h2>
          <div className="grid sm:grid-cols-2 gap-5">
            <div className="bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-white/[0.06] p-5">
              <h3 className="font-medium text-gray-900 dark:text-white mb-2">Fireflies path</h3>
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-white/[0.06] p-5">
              <h3 className="font-medium text-gray-900 dark:text-white mb-2">VideoText path</h3>
        ...
        <section>
          <h2 className="text-2xl font-medium text-gray-900 dark:text-white mb-6">VideoText vs Fireflies</h2>
        ...
        <section className="rounded-xl border border-gray-200 dark:border-white/[0.06] p-6 bg-white dark:bg-gray-900/40">
          <h2 className="text-2xl font-medium text-gray-900 dark:text-white mb-3">Related alternatives</h2>
        ...
        <section className="bg-gradient-to-br from-blue-600 via-blue-600 to-blue-700 rounded-xl p-8 sm:p-12 text-white text-center">
          <h2 className="text-2xl sm:text-3xl font-medium mb-3">Try a no-bot workflow on your next meeting recording</h2>
          ...
          <Link to="/video-to-transcript?source=fireflies-alternative" className="inline-flex items-center gap-2 bg-white text-blue-700 px-8 py-3.5 rounded-xl font-bold text-[15px] shadow-lg hover:shadow-xl transition-all">
