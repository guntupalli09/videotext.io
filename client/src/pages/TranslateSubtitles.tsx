...
export default function TranslateSubtitles(props: TranslateSubtitlesSeoProps = {}) {
  ...
  const kindSelector = (status === 'idle' || inputKind === 'documents') && !docTranslated && (
    <div className="mb-5 rounded-2xl border border-blue-300/60 dark:border-blue-500/40 bg-gradient-to-r from-blue-50 to-blue-50 dark:from-blue-950/30 dark:to-blue-950/20 p-4 sm:p-5">
    ...
    <>
      ...
      {location.pathname === '/translate-subtitles' && (
        <section className="max-w-4xl mx-auto px-4 py-10 space-y-10">
          ...
          <section className="space-y-3"><h2 className="text-2xl font-semibold">Translate SRT Files Without Losing Timestamps</h2><p>Most tools break subtitle timing. This subtitle translator keeps every timestamp intact. Working from video first? Convert your file with <Link to="/video-to-transcript" className="text-blue-600 hover:underline">video to transcript</Link>.</p></section>
          ...
          <section className="space-y-3"><h2 className="text-2xl font-semibold">More Transcription &amp; Subtitle Tools</h2><ul className="list-disc pl-6 space-y-1"><li><Link to="/video-to-transcript" className="text-blue-600 hover:underline">Video to transcript tool</Link></li><li><Link to="/subtitle-generator" className="text-blue-600 hover:underline">Subtitle generator</Link></li><li><Link to="/youtube-transcript-generator" className="text-blue-600 hover:underline">YouTube transcript generator</Link></li><li><Link to="/transcribe-long-videos" className="text-blue-600 hover:underline">Transcribe long videos</Link></li></ul></section>
