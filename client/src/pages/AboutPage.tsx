...
const comparisons = [
  ...
  { competitor: 'Trint', difference: 'Trint starts at $80/month. VideoText starts at $0 and scales to $19/month for the same Whisper AI accuracy.' },
  { competitor: 'Rev', difference: 'Rev AI charges $0.25/minute. VideoText is $19/month flat for 450 minutes — no per-minute billing.' },
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            { plan: 'Free', price: '$0/mo', features: '3 imports/month, no credit card required' },
            { plan: 'Basic', price: '$19/mo', features: '450 minutes, multi-language, no watermark' },
            { plan: 'Pro', price: '$49/mo', features: '1,200 minutes, batch processing, priority queue' },
            { plan: 'Agency', price: '$129/mo', features: '3,000 minutes, batch, priority, multi-seat' },
      ...
      <div className="text-center bg-gray-900 dark:bg-gray-800 rounded-2xl p-10">
        ...
        <p className="text-gray-400 mb-6">3 imports per month. No credit card required. Files deleted after processing.</p>
