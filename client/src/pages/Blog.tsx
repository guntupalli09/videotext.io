  ...
  },
  {
    ...
    content: (
      <div className="space-y-4 text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        <h3 className="text-base font-semibold text-gray-900 dark:text-white mt-6">1) VideoText — best for recorded content workflows</h3>
        <p>
        ...
        <h3 className="text-base font-semibold text-gray-900 dark:text-white mt-6">3) Descript — best for editing-driven teams</h3>
        <p>
        ...
        <h3 className="text-base font-semibold text-gray-900 dark:text-white mt-6">4) Rev — best when human review is non-negotiable</h3>
        <p>
        ...
        <h3 className="text-base font-semibold text-gray-900 dark:text-white mt-6">5) Whisper (local/API) — best for technical teams</h3>
        <p>
        ...
        <h3 className="text-base font-semibold text-gray-900 dark:text-white mt-6">Best transcription software by use case</h3>
        <div className="overflow-x-auto">
          <table className="w-full text-xs border-collapse">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
