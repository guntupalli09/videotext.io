          ...
          <table className="w-full text-xs border-collapse">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                ...
                <th className="text-left py-2 pr-4 font-medium text-gray-900 dark:text-white">Free limit</th>
                <th className="text-left py-2 pr-4 font-medium text-gray-900 dark:text-white">Account needed</th>
                <th className="text-left py-2 font-medium text-gray-900 dark:text-white">Stores files</th>
              </tr>
            </thead>
          ...
          <table className="w-full text-xs border-collapse">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                ...
                <th className="text-left py-2 pr-3 font-medium">Best for</th>
                <th className="text-left py-2 pr-3 font-medium">Output depth</th>
                <th className="text-left py-2 pr-3 font-medium">Retention model</th>
                <th className="text-left py-2 font-medium">Trade-off</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
              {[
                ...
                <tr key={tool}>
                  <td className="py-2 pr-3 font-medium text-gray-800 dark:text-gray-200">{tool}</td>
            ...
            <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
              {[
                ...
                <tr key={uc}>
                  ...
                  <td className="py-2 font-medium text-blue-600 dark:text-blue-400">{tool}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-xs border-collapse">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                <th className="text-left py-2 pr-3 font-medium">Tool</th>
                <th className="text-left py-2 pr-3 font-medium">SRT export</th>
                <th className="text-left py-2 pr-3 font-medium">Burn in</th>
                <th className="text-left py-2 font-medium">Translation</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
              {[
          ...
          <table className="w-full text-xs border-collapse">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                ...
                <th className="text-left py-2 pr-4 font-medium">GPU RAM</th>
                <th className="text-left py-2 font-medium">English WER</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-gray-100 dark:border-gray-800">
              ...
              <tr>
                <td className="py-2 pr-4 font-medium">large-v3</td>
                <td className="py-2 pr-4 font-medium">1.5B params</td>
                <td className="py-2 pr-4 font-medium">~10 GB</td>
                <td className="py-2 font-medium">~2.7%</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className="space-y-4 text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-xs border-collapse">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                <th className="text-left py-2 pr-4 font-medium">Audio Type</th>
                <th className="text-left py-2 pr-4 font-medium">Approx. WER</th>
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-3">
        <span className="text-xs font-medium bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300 px-2.5 py-1 rounded-full">
          {post.tag}
        </span>
    ...
    <div>
      ...
      <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700 space-y-4">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-3">
          ...
          <Link
            to="/guideline-format"
            className="inline-flex items-center justify-center gap-2 rounded-xl border border-blue-300 dark:border-blue-600 bg-white dark:bg-gray-900 text-blue-700 dark:text-blue-300 text-sm font-medium px-5 py-2.5 hover:bg-blue-50 dark:hover:bg-blue-950/40 transition-colors"
          >
          ...
          <>
            <div className="mb-10">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                ...
                <Link to="/guideline-format" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 font-medium">
                  Format your transcript to a client style guide →
                </Link>
                {' · '}
