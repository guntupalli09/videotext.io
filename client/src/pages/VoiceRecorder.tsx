            ...
            {phase === 'recording' && (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <span className="flex items-center gap-1.5 bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 text-xs font-medium px-3 py-1.5 rounded-full uppercase tracking-wide">
                    <motion.span
                  ...
                  <span className="text-3xl font-mono font-medium text-gray-800 dark:text-gray-100 tabular-nums tracking-widest">
                    {formatTime(recSecs)}
                  </span>
                </div>
              ...
              >
                  ...
                  <div className="rounded-xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 overflow-hidden select-none">
                    <div className="px-5 pt-4 pb-3 flex items-center justify-between border-b border-gray-100 dark:border-gray-800">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-medium text-gray-800 dark:text-white">Voice transcript ready!</span>
                      </div>
                ...
                {isPaidPlan && transcript.trim() && (
                  <div className={`rounded-xl border p-4 space-y-3 transition-colors ${
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="ml-auto text-[10px] font-medium text-blue-600 bg-blue-50 dark:bg-blue-900/20 px-2 py-0.5 rounded-full">Pro</span>
                    </div>
                    <div className="flex gap-2">
                      <select
                      ...
                      <button
                        ...
                        className="flex items-center gap-1.5 px-4 py-2 rounded-lg bg-blue-500 hover:bg-blue-600 text-white text-sm font-medium transition-colors disabled:opacity-60 disabled:cursor-not-allowed shrink-0"
                      >
                        {isTranslating ? (
                          <>
                ...
                {!isPaidPlan && transcript.trim().length > 0 && (
                  <div className="rounded-xl border border-blue-200 dark:border-blue-800/40 bg-blue-50/50 dark:bg-blue-950/20 p-4 space-y-3">
                    ...
                    <Link
                      to="/pricing"
                      className="block text-center text-xs font-medium text-blue-600 dark:text-blue-400 hover:underline"
                    >
