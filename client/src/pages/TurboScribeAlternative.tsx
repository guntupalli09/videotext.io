    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      <section className="max-w-5xl mx-auto px-6 py-14">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link to="/video-to-transcript" className="px-5 py-3 rounded-xl bg-blue-600 hover:bg-blue-600 text-white font-semibold">
            Try VideoText Free
          </Link>
          ...
          <table className="min-w-full text-sm">
            <thead className="bg-gray-50 dark:bg-gray-900">
              <tr>
                ...
                <th className="text-left px-4 py-3 font-semibold text-blue-700 dark:text-blue-300">VideoText</th>
