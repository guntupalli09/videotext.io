    ...
    <div className="min-h-screen bg-gray-50 py-12 sm:py-16">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 rounded-xl border border-blue-200 bg-gradient-to-br from-blue-50 to-white p-5 sm:p-6 shadow-sm">
          <p className="text-xs font-medium uppercase tracking-wide text-blue-600 mb-2">Freelancers & QA teams</p>
          ...
          <div className="flex flex-wrap gap-3">
            <Link to="/guideline-format" className="inline-flex items-center justify-center rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium px-4 py-2.5 shadow-sm transition-colors">
              Format your transcript to a client style guide →
            </Link>
            <Link to="/video-to-transcript" className="inline-flex items-center justify-center rounded-xl border border-blue-300 bg-white text-blue-700 text-sm font-medium px-4 py-2.5 hover:bg-blue-50 transition-colors">
              Transcribe first →
            </Link>
