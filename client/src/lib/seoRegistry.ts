...
const MANUAL_REGISTRY: SeoRegistryEntry[] = [
  ...
  // ── Phase 2: 30 high-intent SEO pages ──────────────────────────────────────────
  {
    ...
    title: 'YouTube Transcript Generator — Free, Instant & Accurate | VideoText',
    description: 'Paste any YouTube URL and get a full transcript, AI summary, chapter markers, and SRT/VTT exports in minutes. No download needed. Free to start — 98.5% accuracy.',
    h1: 'YouTube Transcript Generator',
    intro: 'Paste any YouTube URL — get a timestamped transcript, AI summary, chapter markers, and SRT/VTT subtitle exports in minutes. No video download required. Powered by OpenAI Whisper with 98.5% accuracy. Free to start.',
    breadcrumbLabel: 'YouTube Transcript Generator',
    toolKey: 'video-to-transcript',
    relatedSlugs: ['/youtube-to-transcript', '/video-to-subtitles', '/video-to-transcript'],
    indexable: true,
    intentKey: 'youtube-transcript-generator',
    defaultInputMode: 'youtube',
    faq: [
      { q: 'How do I get a transcript from a YouTube video?', a: 'Paste any youtube.com or youtu.be URL into VideoText and click Generate Transcript. No download required — VideoText fetches the audio directly from the URL and returns a full timestamped transcript, AI summary, and chapter markers. The free tier includes 3 imports per month with no credit card required.' },
      { q: 'How long does it take to transcribe a YouTube video?', a: 'Most videos under 30 minutes complete in under 2 minutes. A 1-hour YouTube video typically processes in 3–5 minutes. Processing time scales with video duration and current server load.' },
      { q: 'Is VideoText more accurate than YouTube auto-captions?', a: 'VideoText uses OpenAI Whisper with ~98.5% word accuracy on clear English audio. YouTube auto-captions lack punctuation, miss proper nouns and technical terms, and are not structured for publishing. VideoText outputs are formatted, timestamped, and export-ready.' },
      { q: 'Can I download a YouTube transcript as SRT, TXT, or PDF?', a: 'Yes. After processing, export the transcript as TXT, PDF, DOCX, or JSON. Subtitle files are available as SRT and VTT — ready for direct upload to YouTube Studio, Premiere Pro, or any video platform.' },
      { q: 'Do I need to download the YouTube video first?', a: 'No. Just paste the URL. VideoText processes YouTube videos directly — no download, no file upload, no extra steps required.' },
      { q: 'Can I transcribe long YouTube videos like podcasts or lectures?', a: 'Yes. Long-form YouTube content — podcasts, full lectures, webinar replays, course videos — is fully supported. Free plan handles videos up to 30 minutes. Paid plans support 45 minutes to 4 hours per video.' },
      { q: 'Is the YouTube transcript generator free?', a: 'Yes. The free tier includes 3 transcript jobs per month with no credit card required. Each job produces a full transcript, AI summary, chapter markers, and export files. Paid plans start at $19/month for 450 minutes of processing.' },
      { q: 'Can I turn a YouTube transcript into a blog post or newsletter?', a: 'Absolutely. Repurposing is the primary use case — one YouTube video becomes a keyword-rich blog draft, show notes, email newsletter, social snippets, and chapter descriptions. VideoText structures the output so you can publish without manual cleanup.' },
