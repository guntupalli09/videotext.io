...
const MANUAL_REGISTRY: SeoRegistryEntry[] = [
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Is VideoText cheaper than Trint for solo creators?', a: 'Yes. VideoText Pro is $49/month vs Trint at $80/month for solo creators who need transcript + SRT.' },
  ...
  },
  {
    ...
    description: 'Sonix charges $22/month + $0.10/minute overage. VideoText starts free — same Whisper AI accuracy, SRT/VTT export, subtitle burning, zero per-minute billing. Pro at $49/month.',
