...
export interface SeoRegistryEntry {
  ...
  /** Deprecated — YouTube URL ingestion removed; file upload only. */
...
const MANUAL_REGISTRY: SeoRegistryEntry[] = [
  ...
  // ── YouTube transcription (high SEO potential) ─────────────────────────────────
  {
    ...
    description:
      'Convert any YouTube video to transcript with one click. Upload MP4/MOV/WebM to Video to Transcript. AI transcription in seconds. Free tier. Sign up for free to try.',
    h1: 'YouTube to Transcript — Upload Video, Get Text',
    intro:
      'Upload MP4, MOV, or WebM and get a full transcript in minutes. Whisper large-v3 transcribes the audio with speaker labels, summary, and chapters. Works with public videos, playlists, shorts, and age-restricted content (with optional cookies). Same features as file upload: speakers, summary, chapters, translate to 6 languages.',
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Can I transcribe short-form video?', a: 'Yes. Upload the short as MP4/MOV — same workflow as any video. Transcription quality is the same as regular YouTube videos.' },
  ...
  },
  {
    ...
    canonicalGroup: 'youtube-transcript',
    faq: [
      { q: 'Can I get a transcript from a YouTube video?', a: 'Yes. Download the video as MP4, then upload to Video to Transcript.' },
      { q: 'Does it work with YouTube Shorts?', a: 'Yes. Upload the short as MP4/MOV — same workflow as any video. Same transcription quality as regular videos.' },
  ...
  },
  {
    ...
    description:
      'Convert YouTube videos to text online. Upload MP4/MOV/WebM and get a transcript. Files deleted after processing. Free, AI-powered. Download or copy. Translate to 6 languages.',
    h1: 'YouTube to Text — Convert Videos to Text Online',
    intro:
      'Convert any YouTube video to text with one click. Upload your video and get a full transcript. Download as plain text, copy to clipboard, or translate to English, Hindi, Spanish, Chinese, Russian, or Telugu.',
    ...
    canonicalGroup: 'youtube-transcript',
    faq: [
      { q: 'How do I convert a YouTube video to text?', a: 'Upload your MP4/MOV file and click Start to transcribe.' },
  ...
  },
  {
    ...
    faq: [
      { q: 'Is meeting transcription free?', a: 'Yes. The free tier includes 3 imports per month — sign up for free to try. Create a free account to track usage across browser sessions. Pro plan is $7.99/month for continued processing.' },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'What CPS limit does the scan use?', a: 'Validation flags cues above 21 characters per second (CPS) — an EBU-style warning threshold built into the tool, not Netflix\'s delivery spec — and lines longer than 42 characters per row (CPL). When Fix timing is on, short cues with too much text get extended toward a 1.5-second minimum display where the next cue allows it. Netflix TTSC is 20 CPS for adult programming and 17 CPS for children\'s content; run the free reading-speed checker against your platform preset before delivery.' },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Is adding subtitles to video free?', a: 'Yes. Free tier is available after signing up for free. Upload your video and subtitle file and download the output with captions burned in at no cost within the monthly free limit. Pro plan is $7.99/month for continued processing.' },
    ...
    faq: [
      {
        ...
        a: 'Use VideoText Batch Process: upload several videos in one session, choose transcript or subtitle output, and download a single ZIP with one file per video. Pro supports up to 20 videos per batch.',
      },
      {
  ...
  // ── Transcription variants ──────────────────────────────────────────────────
  {
    ...
    faq: [
      { q: 'Is it free to transcribe a video online?', a: 'Yes. The free tier includes 3 imports per month after signing up for free — just upload and go. Create a free account to track usage across browser sessions. Pro plan is $7.99/month for continued processing.' },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Is online video transcription free?', a: 'Yes. The free tier gives you 3 imports per month after signing up for free. Create a free account to track usage across sessions. Pro plan is $7.99/month and includes multi-language output, speaker diarization, and export in additional formats.' },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Is audio-to-text transcription free?', a: 'Yes. Free tier includes 3 imports per month after signing up for free. Just upload your file and get a transcript immediately. Pro plan is $7.99/month and adds multi-language output, speaker labels, summary, and export formats including JSON, CSV, and Markdown.' },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Is podcast transcription free?', a: 'Yes. Free tier includes 3 imports per month after signing up for free. Pro plan is $7.99/month, suitable for podcasters transcribing every episode through regular production workflows.' },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Is Zoom recording transcription free?', a: 'Yes. Free tier includes 3 imports per month after signing up for free. A typical 30–60 minute Zoom call fits within this limit. Pro plan is $7.99/month for continued processing.' },
    ],
  },
  {
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Is the caption generator free?', a: 'Yes. Sign up for free to try. You get 3 imports per month. Pro plan is $7.99/month for continued processing.' },
  ...
  },
  {
    ...
    toolKey: 'video-to-subtitles',
    relatedSlugs: ['/video-to-subtitles', '/translate-subtitles', '/subtitle-tools'],
    indexable: true,
    intentKey: 'video-to-srt',
    faq: [
      { q: 'How do I convert video to SRT?', a: 'Upload MP4, MOV, or WebM. VideoText transcribes speech with Whisper large-v3 and writes a timed .srt file. Download and upload to YouTube, Vimeo, or any editor.' },
      { q: 'Is video to SRT free?', a: 'Yes. Sign up free for 3 imports per month — no card. Free exports include a watermark; paid plans remove it.' },
      ...
      { q: 'Video to SRT vs SRT file generator?', a: 'Same workflow — video in, timed .srt out. This page is the canonical URL for “video to srt” searches. /srt-generator redirects here. For the full caption hub, use /video-to-subtitles.' },
    ],
  },
  ...
  // ── Phase 2: 30 high-intent SEO pages ──────────────────────────────────────────
  {
    ...
    deepContent: {
      ...
      workflowSteps: [
        {
          title: 'Upload MP4/MOV',
          detail: 'Download your video as MP4/MOV, then upload to Video to Transcript.',
        },
        {
      ...
      comparisonRows: [
        ...
        { feature: 'Cost for YouTube creator (100 videos/year)', videotext: 'Free (3 imports/month) or Pro $7.99/mo flat rate', alternatives: 'YouTube captions: free but low quality | Rev: $125+ per video | Professional: $1000+/month' },
  ...
  },
  {
    ...
    description: 'Convert video to text online. Upload MP4, MOV, WebM or upload MP4/MOV. Get accurate transcripts in seconds. Export SRT, TXT, DOCX.',
    h1: 'Video to Text Converter',
    intro: 'Convert any video to text online. Upload your file or upload MP4/MOV. Our AI transcribes speech to text in seconds. Download as TXT, SRT, or view in 6 languages. Free tier.',
  ...
  },
  {
    ...
    description: 'Transcribe video online free. Upload any video or upload MP4/MOV. Get accurate transcripts. Export SRT, TXT, DOCX. AI-powered. No download.',
    h1: 'Transcribe Video Online',
    intro: 'Transcribe any video online in seconds. Upload MP4, MOV, WebM or upload your video. Our AI converts speech to text. Export SRT, TXT, or translate to 6 languages. Free tier.',
    ...
    faq: [
      { q: 'How do I transcribe a video online?', a: 'Upload your video file or upload MP4/MOV. Click Transcribe and get a full text transcript in seconds.' },
  ...
  },
  {
    ...
    description: 'Generate YouTube subtitles. Upload MP4/MOV/WebM. Get SRT/VTT for YouTube. Accurate timestamps. Free tier.',
    h1: 'YouTube Subtitle Generator',
    intro: 'Generate subtitles for YouTube videos. Upload your video. Get SRT or VTT with accurate timestamps. Upload to YouTube Studio. Free tier.',
    ...
    faq: [
      { q: 'How do I generate subtitles for a YouTube video?', a: 'Upload your video, choose SRT, download the file, and upload to YouTube Studio as captions.' },
  ...
  },
  {
    ...
    toolKey: 'video-to-subtitles',
    relatedSlugs: ['/video-to-subtitles', '/video-to-srt'],
    indexable: true,
  ...
  },
  {
    ...
    description: 'No desktop install. Upload MP4/MOV/WebM → transcript + SRT + summary. Free: 3 imports/mo, no card.',
    h1: 'Descript Alternative — Browser Transcript',
    intro: 'Descript is a powerful video editor. But if your workflow is transcription-first — getting clean text fast, exporting SRT subtitles, and exporting SRT subtitles — Descript is slow, expensive, and overkill. We ran the same 60-minute recording through both. Here is what actually happened.',
    ...
    deepContent: {
      proofPoints: [
        ...
        'Descript requires a desktop app. VideoText runs in any browser — upload and done.',
      ...
      comparisonRows: [
        ...
        { feature: 'Subtitle burn-in', videotext: 'Yes — included free', alternatives: 'Descript: No' },
      ...
      useCases: [
        ...
        { title: 'Use VideoText if: you need SRT + transcript in one pass', body: 'Upload MP4/MOV once — transcript + SRT in minutes. Descript is editor-first and starts at $24/month.' },
    ...
    faq: [
      ...
      { q: 'Does VideoText replace Descript for transcription-only workflows?', a: 'Yes. Upload MP4/MOV to Video to Transcript. Descript does not support direct Subtitle burn-in.' },
      ...
      { q: 'Does VideoText generate subtitles and SRT files like Descript?', a: 'Yes. VideoText generates broadcast-ready SRT and VTT files from any uploaded video in one step. Included in the free tier.' },
  ...
  },
  {
    ...
    description: 'No live bot. Upload the recording or upload MP4/MOV. Transcript + SRT + summary + chapters. Free: 3 imports/mo, no card.',
    ...
    deepContent: {
      proofPoints: [
        ...
        'Otter.ai does not export SRT on free tier. VideoText includes SRT/VTT export on the free tier.',
      ...
      comparisonRows: [
        ...
        { feature: 'Subtitle burn-in', videotext: 'Yes — MP4/MOV upload', alternatives: 'Otter.ai: No' },
    ...
    faq: [
      ...
      { q: 'Can Otter.ai generate SRT subtitle files?', a: 'No. Otter.ai outputs meeting notes and transcripts, but not SRT or VTT subtitle files. VideoText generates broadcast-ready SRT and VTT from any video upload — included in the free tier.' },
      { q: 'Can Otter.ai generate SRT subtitle files from video?', a: 'No. Otter.ai does not export SRT from video uploads. Upload MP4/MOV and get transcript, SRT, summary, and chapters. Files deleted after processing.' },
      { q: 'Does VideoText support live meeting transcription like Otter.ai?', a: 'No. VideoText transcribes recorded files — upload an MP4 or upload MP4/MOV. For real-time live meeting transcription during active calls, Otter.ai is the better choice.' },
  ...
  },
  {
    ...
    deepContent: {
      proofPoints: [
        'Rev charges $0.25/minute. A 60-minute recording costs $15. VideoText Pro is $7.99/month flat rate — no per-minute fees.',
        ...
        'Rev AI tier does not include SRT export. VideoText includes SRT/VTT on the free tier.',
      ...
      comparisonRows: [
        ...
        { feature: 'Cost model', videotext: '$7.99/mo flat rate — $0 free tier', alternatives: 'Rev: $0.25/min AI, $1.99/min human' },
        { feature: 'Accuracy (clear audio)', videotext: '98.5%+ (Whisper large-v3)', alternatives: 'Rev AI: ~90–95% | Rev Human: 99%+' },
        { feature: 'Subtitle burn-in', videotext: 'Yes — MP4/MOV upload', alternatives: 'Rev: No' },
    ...
    faq: [
      ...
      { q: 'How much cheaper is VideoText than Rev?', a: 'Rev charges $0.25/minute. A 60-minute recording costs $15. VideoText has a free tier (3 imports/month) and Pro at $7.99/month. For high-volume work, VideoText is far cheaper.' },
      ...
      { q: 'Does VideoText include SRT export unlike Rev AI?', a: 'Yes. Upload MP4/MOV to Video to Transcript. Rev does not support direct Subtitle burn-in.' },
  ...
  },
  {
    ...
    deepContent: {
      proofPoints: [
        ...
        'Trint stores files in their cloud. VideoText deletes files immediately after processing.',
      ...
      comparisonRows: [
        ...
        { feature: 'Subtitle burn-in', videotext: 'Yes — included free', alternatives: 'Trint: No' },
      ...
      outputExamples: [
        ...
        { title: 'What VideoText delivers at $0', body: 'Full transcript with speaker labels, AI summary, chapter timestamps, and SRT subtitle file — all from one upload. Ready to publish in under 5 minutes. No team editing features, but for individual creators and small teams, the free tier covers the full workflow.' },
      ...
      useCases: [
        { title: 'Use VideoText if: you are a solo creator or small team', body: 'The free tier (3 imports/month) and Pro plan ($7.99/month) cover the full workflow for most creators — transcript, SRT, summary, chapters, translation, and subtitle burning. No reason to pay $80/month for Trint.' },
        { title: 'Use VideoText if: you transcribe YouTube or online video', body: 'VideoText covers transcript + SRT + translate + burn in one platform. Upload MP4/MOV and publish in under 5 minutes.' },
    ...
    faq: [
      { q: 'How much cheaper is VideoText than Trint?', a: 'Trint starts at $80/month. VideoText has a free tier (3 imports/month) and Pro at $7.99/month. For solo creators and small teams, VideoText is about 90% cheaper for the same core transcription workflow.' },
      { q: 'Is VideoText cheaper than Trint for solo creators?', a: 'Yes. VideoText Pro is $7.99/month vs Trint at $80/month for solo creators who need transcript + SRT.' },
  ...
  },
  {
    ...
    description: 'Upload MP4/MOV/WebM. Transcript + SRT + summary + chapters. Free: 3 imports/mo, no card. Files deleted after processing.',
    ...
    deepContent: {
      proofPoints: [
        ...
        'TurboScribe is editor-first. VideoText is transcription-first — upload MP4/MOV for transcript + SRT in minutes.',
      ...
      comparisonRows: [
        ...
        { feature: 'Subtitle burn-in', videotext: 'Yes — included free', alternatives: 'TurboScribe: No — must download and re-upload' },
      ...
      useCases: [
        ...
        { title: 'Use VideoText if: you need SRT + transcript in one pass', body: 'Upload once on VideoText — transcript, SRT, summary, and chapters in one pass. TurboScribe outputs plain text only.' },
    ...
    faq: [
      ...
      { q: 'Does TurboScribe export SRT subtitle files?', a: 'No. TurboScribe requires you to download the video file and then upload it. Upload MP4/MOV and get a transcript in under 5 minutes.' },
  ...
  },
  {
    ...
    description: 'Upload a file. Transcript + SRT, then translate or burn. Free: 3 imports/mo, no card.',
    h1: 'HappyScribe Alternative — Start Free',
    intro: 'HappyScribe starts at $17/month with no free tier and no free tier. VideoText starts at $0 — and handles the complete subtitle workflow HappyScribe splits across multiple steps and paid tiers. Here is the exact comparison.',
    ...
    deepContent: {
      proofPoints: [
        ...
        'HappyScribe has no free tier and no burn-in tool. VideoText starts free with SRT + translate + burn.',
        'HappyScribe does not burn subtitles into video. VideoText includes a free burn-subtitles tool in the same platform.',
        'HappyScribe starts at $17/month for 120 minutes. VideoText Pro is $7.99/month for continued processing — no per-minute caps.',
      ...
      comparisonRows: [
        ...
        { feature: 'Starting price', videotext: '$0 to start, $7.99/mo Pro', alternatives: 'HappyScribe: $17/mo for 120 min' },
        { feature: 'Subtitle burn-in', videotext: 'Yes — browser tool', alternatives: 'HappyScribe: No — must download and re-upload' },
        ...
        { feature: 'Value', videotext: 'Flat-rate Pro at $7.99/mo', alternatives: 'HappyScribe: ~7 min/$1 (pay-as-you-go)' },
      ...
      outputExamples: [
        ...
        { title: 'The subtitle workflow on VideoText', body: 'Upload video (or upload MP4/MOV) → get transcript + SRT in under 5 minutes → translate SRT to any of 70+ languages in one click → burn subtitles permanently into the video. All in one platform. Free to start.' },
      ...
      useCases: [
        { title: 'Use VideoText if: you need a complete subtitle workflow', body: 'VideoText covers transcription, SRT export, translation, and subtitle burning in one platform — for free. HappyScribe requires a separate tool for burning and has no SRT/VTT export.' },
    ...
    faq: [
      ...
      { q: 'Does VideoText include subtitle burn-in unlike HappyScribe?', a: 'Yes, and it is easier. Upload MP4/MOV to Video to Transcript. HappyScribe requires you to download and upload the file manually.' },
      ...
      { q: 'How does VideoText pricing compare to HappyScribe?', a: 'HappyScribe starts at $17/month for 120 minutes (~$0.14/min). VideoText Pro is $7.99/month flat, continued processing — and starts free with no credit card required.' },
    ],
  },
  {
    path: '/sonix-alternative',
    title: 'Best Free Sonix Alternative – No Per-Minute Fees | VideoText',
    description: 'Sonix charges $22/month + $0.10/minute overage. VideoText starts free — same Whisper AI accuracy, SRT/VTT export, subtitle burning, zero per-minute billing. Pro at $7.99/month.',
    h1: 'Sonix Alternative',
    intro: 'Looking for a Sonix alternative? VideoText transcribes video with Whisper AI, exports SRT/VTT, translates subtitles to 70+ languages, and burns captions — all at a flat price with no per-minute fees. Free tier. Files deleted after processing.',
    ...
    faq: [
      { q: 'Is VideoText cheaper than Sonix?', a: 'Yes. Sonix is $22/month base + $0.10/min overage. VideoText Pro is $7.99/month flat — no surprise charges for longer videos, no per-minute fees.' },
      { q: 'Does VideoText support Subtitle burn-in like Sonix does not?', a: 'Correct. VideoText lets you upload MP4/MOV and transcribes directly. Sonix requires downloading and uploading the file.' },
  ...
  },
  {
    ...
    description: 'EasyScribe covers basic audio transcription only. VideoText transcribes video files, exports SRT subtitles, translates to 70+ languages, and burns captions. Free tier.',
    h1: 'EasyScribe Alternative',
    intro: 'Looking for an EasyScribe alternative? VideoText handles the full video transcription workflow — MP4 uploads, Subtitle burn-in, SRT/VTT subtitle export, 70+ language translation, subtitle burning, and batch processing. Free tier, no credit card needed.',
    ...
    faq: [
      { q: 'What can VideoText do that EasyScribe cannot?', a: 'VideoText generates SRT/VTT subtitle files, translates to 70+ languages, burns subtitles into video, exports SRT/VTT, and processes batches. EasyScribe only produces plain-text transcripts.' },
      ...
      { q: 'Can VideoText transcribe YouTube videos?', a: 'Yes. Download the video as MP4, upload to Video to Transcript, and get transcript + SRT.' },
  ...
  },
  {
    ...
    deepContent: {
      proofPoints: [
        ...
        'Complete workflow: VideoText returns transcript + SRT + summary + chapters in one upload.',
      ...
      comparisonRows: [
        ...
        { feature: 'Best for: price', videotext: 'VideoText — $0 free tier, $7.99/mo Pro', alternatives: 'TurboScribe ($10/mo) for basic text only' },
        { feature: 'Best for: YouTube transcription', videotext: 'VideoText — upload MP4/MOV', alternatives: 'Others require separate tools for SRT + burn' },
    ...
    faq: [
      { q: 'What makes VideoText the best transcription tool for video?', a: 'VideoText is the only tool that returns transcript + AI summary + chapter timestamps + SRT subtitle files in one job, in under 5 minutes, starting at $0. It returns transcript + SRT + summary + chapters in one job — most tested tools return text only.' },
      { q: 'Is VideoText better than Otter.ai?', a: 'For recorded video, yes. VideoText accepts video files; Otter.ai does not. For live meeting transcription, Otter.ai is better — it joins Zoom/Meet/Teams in real time. VideoText does not support live meetings.' },
      ...
      { q: 'Is VideoText better than TurboScribe?', a: 'Yes for most workflows. VideoText is 3× faster, produces structured output (summary + chapters + SRT), exports SRT/VTT, and starts free. TurboScribe produces raw text only and charges $10/month.' },
  ...
  },
  {
    ...
    title: 'YouTube Video Transcription | VideoText',
    description: 'Turn any video upload into transcript, summary, and chapters. Upload MP4/MOV, transcribe fast, and export text or subtitle files.',
    h1: 'YouTube Video Transcription',
    intro: 'Upload MP4/MOV and get a structured transcript workflow in minutes: text, summary, chapters, and subtitle-ready output.',
    breadcrumbLabel: 'YouTube Video Transcription',
    toolKey: 'video-to-transcript',
    ...
    deepContent: {
      proofPoints: [
        ...
        'No manual download flow: upload MP4/MOV directly and transcribe.',
        'Structured output includes transcript text, chapter points, and subtitle-ready exports.',
      ],
      workflowSteps: [
        { title: 'Step 1 — Upload video', detail: 'Upload MP4, MOV, or WebM. Processing starts in seconds.' },
      ...
      comparisonRows: [
        { feature: 'File upload workflow', videotext: 'Upload MP4/MOV and transcribe', alternatives: 'Often require extra steps or manual file workflow' },
      ...
      ctaText: 'Upload a video and transcribe now',
      ctaPath: '/youtube-url-to-transcription',
    },
    faq: [
      { q: 'Can I transcribe YouTube directly from a URL?', a: 'Yes. Download the video as MP4, upload to Video to Transcript, and click Start.' },
      { q: 'What output do I get from video transcription?', a: 'You get full transcript text plus optional summary, chapter points, and subtitle export formats like SRT/VTT.' },
      { q: 'Does this work for Shorts?', a: 'Yes. Shorts URLs are supported with the same transcription flow as standard YouTube videos.' },
      { q: 'Is video transcription free?', a: 'Yes. Free tier includes 3 imports per month. Sign up for free to test with real videos.' },
    ],
  },
  {
  ...
  },
  {
    ...
    description: 'Best YouTube transcription tool. Upload MP4/MOV, get transcript + SRT. Fast. Free tier.',
    h1: 'Best YouTube Transcription Tool',
    intro: 'VideoText is among the best YouTube transcription tools. Upload MP4/MOV. Get a transcript in minutes. Export SRT, TXT. Free tier.',
    ...
    faq: [
      { q: 'How do I transcribe a YouTube video with VideoText?', a: 'Upload MP4/MOV and click Start. Transcript ready in minutes.' },
  ...
  },
  {
    ...
    deepContent: {
      proofPoints: [
        ...
        'Rev AI: ~5 minutes, but no SRT on AI tier, no summary.',
      ...
      comparisonRows: [
        ...
        { feature: 'TurboScribe', videotext: '~11 minutes', alternatives: 'No SRT | No SRT export | $10/month minimum' },
        { feature: 'Rev AI', videotext: '~5 minutes', alternatives: 'No SRT export | No SRT in AI tier | $0.25/min' },
        { feature: 'Trint', videotext: '~6 minutes', alternatives: 'No SRT export | $80/month' },
        { feature: 'HappyScribe', videotext: '~5 minutes', alternatives: 'No SRT export | No free tier | No subtitle burning' },
        { feature: 'Sonix', videotext: '~5 minutes', alternatives: 'No SRT export | $22/mo + per-minute overage' },
        { feature: 'Otter.ai', videotext: '~8 minutes (audio only)', alternatives: 'No video upload | No SRT | No SRT export' },
        { feature: 'Descript', videotext: '~18 minutes', alternatives: 'No SRT export | $24/month | Desktop app required' },
      ],
      useCases: [
  ...
  // ── Cluster A: Platform-Specific Pages ──────────────────────────────────────
  {
    ...
    faq: [
      ...
      { q: 'Is TikTok transcription free?', a: 'Yes. Free tier includes 3 imports per month. Sign up for free to try. Pro plan is $7.99/month with expanded workflow access.' },
    ],
  },
  {
    ...
    h1: 'Instagram Reel Transcript — Upload Video',
  ...
  },
  {
    ...
    description: 'Upload a Loom MP4 (or upload MP4/MOV) and get a transcript plus SRT/VTT, summary, and chapters. Whisper large-v3. 3 free imports/mo, no card.',
    h1: 'Loom to Transcript — Upload the Recording',
    intro: 'Download the Loom MP4, then upload it on Video to Transcript — or upload MP4/MOV if you already posted the clip there. You get transcript + SRT/VTT + summary + chapters. Whisper large-v3. Files deleted after processing. Free: 3 imports/mo, no card.',
    ...
    faq: [
      { q: 'How do I turn a Loom video into a transcript?', a: 'In Loom, download the MP4. Upload that file on Video to Transcript (this page uses the same tool). If you republished the Loom to YouTube, download that MP4 and upload it here.' },
      { q: 'Do I paste a Loom share URL?', a: 'VideoText accepts an uploaded video file. Download the Loom recording first, then upload. No Loom bot joins the recording.' },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Is Teams meeting transcription free?', a: 'Yes. Free tier includes 3 imports per month. Sign up for free to try. Pro plan is $7.99/month, suitable for teams with weekly meetings.' },
  ...
  },
  {
    ...
    description: 'Upload a Vimeo MP4 (or upload MP4/MOV) and get a transcript plus SRT/VTT, summary, and chapters. Whisper large-v3. 3 free imports/mo, no card.',
    h1: 'Vimeo to Transcript — Upload the Video',
    intro: 'Download your Vimeo MP4, then upload it on Video to Transcript — or upload MP4/MOV if the same video lives there. You get transcript + SRT/VTT + summary + chapters. Whisper large-v3. Files deleted after processing. Free: 3 imports/mo, no card.',
    ...
    faq: [
      { q: 'How do I turn a Vimeo video into a transcript?', a: 'Download the MP4 from Vimeo (your library, or the download button if enabled). Upload that file on Video to Transcript. If you also posted it to YouTube, download that MP4 and upload it here.' },
      { q: 'Can I paste a vimeo.com URL?', a: 'VideoText accepts an uploaded file. Download from Vimeo first, then upload here.' },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Is screen recording transcription free?', a: 'Yes. Free tier includes 3 imports per month. Sign up for free to try. Pro plan is $7.99/month with expanded workflow access.' },
  ...
  // ── Cluster C: Competitor Alternative Pages ──────────────────────────────────
  {
    ...
    faq: [
      ...
      { q: 'Is VideoText free?', a: 'Yes. Free tier includes 3 imports per month. Pro plan is $7.99/month with expanded workflow access.' },
    ],
  },
  {
  ...
  // ── Cluster D: Audio Format Pages ────────────────────────────────────────────
  {
    ...
    faq: [
      ...
      { q: 'Is MP3 to text conversion free?', a: 'Yes. Free tier includes 3 imports per month. Sign up for free to try. Pro plan is $7.99/month with expanded workflow access.' },
    ],
  },
  {
    path: '/wav-to-text',
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Yes. Free tier includes 3 imports per month with no credit card. Pro plan is $7.99/month with expanded workflow access.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Yes. Free tier includes 3 imports per month. Sign up for free to try. Pro plan is $7.99/month with expanded workflow access.',
      },
    ],
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Yes. Free tier includes 3 imports per month with no credit card. Most dissertation students upgrade to Pro ($7.99/month) during intensive fieldwork periods.',
      },
    ],
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Yes. Free tier includes 3 imports per month with no credit card. For intensive fieldwork, the Pro plan ($7.99/month) provides continued processing with no per-minute fees.',
      },
    ],
  },
  {
  ...
  // ── Cluster G: Meeting Platform Alternatives ────────────────────────────────
  {
    ...
    faq: [
      ...
      { q: 'Is VideoText free for Zoom transcription?', a: 'Yes. Free tier includes 3 imports per month. No credit card. Pro plan is $7.99/month with expanded workflow access.' },
    ],
  },
  {
    ...
    faq: [
      ...
      { q: 'Is VideoText cheaper than Microsoft Copilot for transcription?', a: 'Yes. Microsoft 365 Copilot costs $30/user/month per person. VideoText free tier costs $0. Pro plan is $7.99/month for the whole team\'s transcription needs.' },
    ],
  },
  {
  ...
  // ── Cluster H: AI Meeting Notes Alternatives ────────────────────────────────
  {
    ...
    faq: [
      ...
      { q: 'Is VideoText free like Notta?', a: 'Yes. Free tier includes 3 imports per month with no credit card. Pro plan is $7.99/month.' },
    ],
  },
  {
    ...
    faq: [
      ...
      { q: 'Is VideoText free like Tactiq\'s free plan?', a: 'Yes. Free tier includes 3 imports per month, no credit card. Pro plan is $7.99/month flat — no per-minute fees.' },
    ],
  },
  {
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'What extra features does VideoText have over Buzz?', a: 'VideoText adds speaker diarization, auto-generated summary, chapter navigation, keyword indexing, SRT/VTT subtitle export, subtitle translation to 70+ languages, and Subtitle burn-in. Buzz outputs raw transcript text only.' },
  ...
  },
  {
    ...
    toolKey: 'video-to-subtitles',
    relatedSlugs: ['/video-to-subtitles', '/fix-subtitles', '/video-to-srt', '/burn-subtitles'],
    indexable: true,
  ...
  },
  {
    ...
    toolKey: 'video-to-transcript',
    relatedSlugs: ['/video-to-subtitles', '/video-to-srt', '/translate-subtitles', '/capcut-alternative'],
    indexable: true,
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'What can VideoText transcribe?', a: 'Any audio or video file: MP4, MOV, AVI, WebM, MKV, MP3, WAV, M4A, AAC, OGG, FLAC. Supports MP4, MOV, WebM, MKV, and common audio formats.' },
    ],
  },
  ...
  },
  {
    ...
    toolKey: 'video-to-subtitles',
    relatedSlugs: ['/video-to-subtitles', '/fix-subtitles', '/translate-subtitles', '/video-to-srt'],
    indexable: true,
  ...
  // ── Cluster M: Niche Transcription Services ──────────────────────────────────
  {
    ...
    faq: [
      { q: 'What does VideoText offer as a Genio alternative?', a: 'Whisper large-v3 accuracy, speaker labels, summary, chapters, keyword index, SRT/VTT/TXT export, Subtitle burn-in, translate to 70+ languages, and files deleted after processing.' },
      { q: 'Is VideoText free?', a: 'Yes. 3 imports per month, no credit card.' },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Is VideoText free?', a: 'Yes. 3 imports per month, no credit card.' },
      { q: 'What file formats does VideoText support?', a: 'VideoText accepts MP4, MOV, AVI, WebM, MKV (video) and MP3, WAV, M4A, AAC, OGG, FLAC (audio). Upload MP4/MOV/WebM from your editor or platform download.' },
  ...
  },
  {
    ...
    faq: [
      { q: 'What does VideoText offer over Allscribe?', a: 'Speaker diarization, auto-generated summary, chapter navigation, keyword indexing, SRT/VTT subtitle export, translation to 70+ languages, Subtitle burn-in, and instant file deletion after processing.' },
      { q: 'Is VideoText free?', a: 'Yes. 3 imports per month, no credit card.' },
  ...
  },
  {
    ...
    toolKey: 'video-to-subtitles',
    relatedSlugs: ['/video-to-subtitles', '/video-to-srt', '/video-to-srt', '/subtitle-edit-alternative'],
    indexable: true,
  ...
  },
  {
    ...
    faq: [
      { q: 'Is VideoText better than Vocallab.io?', a: 'VideoText offers Whisper large-v3 transcription, speaker diarization, auto-summary, chapter navigation, keyword indexing, SRT/VTT/TXT export, translation to 70+ languages, and Subtitle burn-in. Files are deleted immediately after processing.' },
      { q: 'Is VideoText free?', a: 'Yes. 3 imports per month, no credit card.' },
      { q: 'What file formats does VideoText accept vs Vocallab?', a: 'VideoText accepts all major video (MP4, MOV, AVI, WebM, MKV) and audio formats (MP3, WAV, M4A, AAC, OGG, FLAC). Upload MP4/MOV/WebM — no desktop install required.' },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'What video formats can I upload to VideoText?', a: 'MP4, MOV, AVI, WebM, MKV, and all major audio formats (MP3, WAV, M4A, AAC, OGG, FLAC). You can also upload MP4/MOV to transcribe directly without uploading.' },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'What can VideoText transcribe that Whisper Notes cannot?', a: 'VideoText transcribes video files (MP4, MOV), podcast recordings, meeting recordings, and any audio file. Whisper Notes is limited to dictation from microphone input on Apple devices.' },
    ],
  },
  ...
  // ── Voice-to-Text: Core Landing Pages ────────────────────────────────────────
  {
    ...
    faq: [
      ...
      { q: 'Is voice to text free?', a: 'Yes. The free tier includes 3 recordings per month with no credit card required. Pro plan is $7.99/month with longer-file and professional workflow access.' },
  ...
  },
  {
    ...
    faq: [
      { q: 'Is voice to text really free?', a: 'Yes. VideoText offers 3 imports per month with no credit card required. Create an account to track your usage. Pro plan is $7.99/month for continued processing.' },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Does VideoText have a free plan like Speechify?', a: 'Yes. VideoText offers 3 free transcriptions per month with no credit card. Pro plan is $7.99/month with expanded workflow access.' },
  ...
  },
  {
    ...
    intro: 'Looking for a Subly alternative? Subly charges per video credit. VideoText uses a flat monthly plan — process as many videos as your plan allows without per-video charges. Upload any video or upload MP4/MOV, get SRT and VTT files, translate to 70+ languages, and burn captions into video. Free tier available.',
    ...
    faq: [
      ...
      { q: 'Is VideoText free?', a: 'Yes. Free tier includes 3 imports per month. Pro plan is $7.99/month with no per-video credit charges.' },
    ],
  },
  {
  ...
  },
  {
    ...
    intro: 'Looking for a Maestra alternative? Maestra bills per minute of audio processed. VideoText uses a flat plan — one import covers your full video regardless of length. Upload any video and get a transcript, SRT/VTT files, speaker labels, and translation to 70+ languages. No watermark on subtitle file exports.',
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Is VideoText free?', a: 'Yes. Free tier includes 3 imports per month. No credit card required. Pro plan is $7.99/month.' },
    ],
  },
  {
    ...
    intro: 'ADA Section 508 and WCAG 2.1 Level AA require synchronised captions for pre-recorded video content on public websites. VideoText generates accurate captions from any video in under 2 minutes. Upload an MP4 or upload MP4/MOV and get a fully synchronised SRT or VTT file ready for upload. Used by universities, government agencies, corporate training teams, and healthcare providers.',
...

  {
    ...
    toolKey: 'video-to-subtitles',
    relatedSlugs: ['/video-to-subtitles', '/video-to-srt', '/video-to-srt', '/how-to-add-subtitles-to-mp4'],
    indexable: true,
    ...
    faq: [
      ...
      { q: 'How do I create an SRT file from a video?', a: 'Upload your video to VideoText (or upload MP4/MOV). The AI transcribes the audio and generates a precisely timed SRT file. Download the SRT and it\'s ready to use. This is far faster than writing timestamps manually.' },
  ...
  // ── Missing high-volume keyword pages ───────────────────────────────────────
  {
    ...
    description: 'Generate automatic captions for any video online. Upload your video or upload MP4/MOV and get accurate auto captions as SRT or VTT in seconds. Free tier. AI-powered.',
    h1: 'Auto Captions — Generate Automatic Captions for Any Video',
    intro: 'Generate accurate auto captions for any video in seconds. Upload your video file (MP4, MOV, AVI, WebM) or upload MP4/MOV and our AI automatically captions your video — producing broadcast-ready SRT and VTT files. Better accuracy than YouTube or TikTok built-in auto-captions. Free tier.',
    ...
    faq: [
      { q: 'How do I auto caption a video?', a: 'Upload your video to VideoText and click Generate Subtitles. Our AI automatically captions the video — detecting every word, aligning it to a timestamp, and producing an SRT or VTT file in seconds. Works for MP4, MOV, AVI, WebM,.' },
      ...
      { q: 'Can I auto caption a YouTube video?', a: 'Yes. Upload MP4/MOV to VideoText and get automatic captions as an SRT file. Download and upload to YouTube Studio for accurate captions on your video.' },
  ...
  },
  {
    ...
    description: 'Free online subtitle maker. Upload a video and create accurate SRT and VTT subtitle files in seconds. AI-powered. No software needed. Free tier available.',
    h1: 'Subtitle Maker — Create Subtitles for Any Video',
    intro: 'Create subtitles for any video with AI. Upload your video file or upload MP4/MOV and our subtitle maker generates timed SRT and VTT files in seconds. Translate subtitles to 70+ languages. Burn them into your video. Download and upload to YouTube, Vimeo, or any platform. No software to install — free tier available.',
    breadcrumbLabel: 'Subtitle Maker',
    toolKey: 'video-to-subtitles',
    relatedSlugs: ['/video-to-subtitles', '/caption-generator', '/auto-captions', '/video-to-srt'],
    indexable: true,
    ...
    faq: [
      ...
      { q: 'Is the subtitle maker free?', a: 'Yes. Free tier includes 3 imports per month, no credit card required. Pro plan is $7.99/month with expanded workflow access.' },
      ...
      { q: 'Can I make subtitles for a YouTube video?', a: 'Yes. Upload MP4/MOV to Video to Transcript. Get an SRT subtitle file ready to upload to YouTube Studio.' },
    ],
  },
  {
    path: '/caption-maker',
    ...
    intro: 'Make captions for any video using AI. Upload a video file or upload MP4/MOV and our caption maker produces broadcast-ready SRT and VTT files in seconds. Translate to 70+ languages. Burn captions into the video permanently. Free tier, no software needed.',
  ...
  },
  {
    ...
    description: 'Generate accurate YouTube captions. Upload your video or upload MP4/MOV and get an SRT file ready to upload to YouTube Studio. Better than YouTube auto-captions. Free tier.',
    h1: 'YouTube Captions — Generate Accurate SRT for YouTube',
    intro: 'Generate accurate captions for YouTube. Upload your video file or upload MP4/MOV and get a broadcast-ready SRT file to upload to YouTube Studio. Our AI produces captions with 98.5%+ accuracy — significantly better than YouTube\'s built-in auto-captions, especially for accents, technical content, and non-English videos. Free tier.',
    ...
    faq: [
      ...
      { q: 'How do I get captions for a YouTube video?', a: 'Download the video as MP4, upload to VideoText, and generate an SRT file with accurate timestamps. Upload the SRT to YouTube Studio.' },
  ...
  },
  {
    ...
    description: 'AI captioning for any video. Upload a file or upload MP4/MOV and get accurate SRT/VTT captions generated by AI in seconds. 98.5%+ accuracy. Free tier. No software needed.',
    h1: 'AI Captioning — Generate Accurate Captions Automatically',
    intro: 'Use AI to caption any video automatically. VideoText\'s AI captioning tool generates broadcast-ready SRT and VTT caption files from any uploaded video in seconds. Powered by OpenAI Whisper large-v3 — the most accurate open-source speech model available. Translate captions to 70+ languages. Burn captions into video. Free tier.',
    ...
    faq: [
      ...
      { q: 'What is the best AI captioning tool?', a: 'VideoText is the best AI captioning tool for video files. It is the fastest (60-min video in under 5 minutes), most accurate (Whisper large-v3), and supports Subtitle burn-in with no download required.' },
    ],
  },
  {
    path: '/whisper-transcription',
    title: 'Whisper Transcription Online | VideoText',
    description: 'Use Whisper AI transcription online — no setup, no GPU, no code. Upload any video or upload MP4/MOV. Powered by OpenAI Whisper large-v3. 98.5%+ accuracy. Free tier.',
    h1: 'Whisper Transcription Online — Use Whisper Without the Setup',
    intro: 'Use OpenAI Whisper transcription in your browser — no GPU, no Python, no setup. VideoText is powered by Whisper large-v3 and delivers Whisper-quality transcription as a web app. Upload any video or upload MP4/MOV and get a full transcript, SRT subtitles, AI summary, and chapters. 98.5%+ accuracy in 50+ languages. Free tier.',
  ...
  },
  {
    ...
    description: 'Generate captions for any video online. Upload your video or upload MP4/MOV and get accurate SRT/VTT caption files in seconds. AI-powered, 98.5%+ accuracy. Free tier.',
    h1: 'Video Captions — Generate Accurate Captions for Any Video',
    intro: 'Generate accurate captions for any video using AI. Upload your video file (MP4, MOV, AVI, WebM) or upload MP4/MOV and get broadcast-ready SRT and VTT caption files in seconds. Translate captions to 70+ languages. Burn captions into video permanently. Free tier.',
  ...
  },
  {
    ...
    description: 'VideoText is the best AI caption generator for videos in 2026. Fastest processing, highest accuracy (98.5%+), Subtitle burn-in, SRT/VTT export, translation to 70+ languages. Free tier.',
    h1: 'Best Caption Generator for Videos — Evidence-Based Ranking',
    intro: 'VideoText is the best AI caption generator for videos. It is the fastest (60-min video in under 5 minutes), most accurate (98.5%+ via Whisper large-v3), and includes the most output options: SRT, VTT, subtitle translation to 70+ languages, subtitle burning, and Subtitle burn-in without downloading. Starts free — no credit card required.',
    ...
    faq: [
      { q: 'What is the best caption generator for YouTube?', a: 'VideoText is the best caption generator for YouTube: it accepts MP4/MOV uploads, produces SRT files ready to upload to YouTube Studio, achieves 98.5%+ accuracy, and translates captions to 70+ languages. Starts free.' },
  ...
  // ── GOTRANSCRIPT ──────────────────────────────────────────────────────────
  {
    ...
    intro: 'The complete GoTranscript style guide for freelance transcribers. Covers clean verbatim requirements, job-specific timestamping [00:00:00], bold speaker labels, inaudible/unintelligible tags, and every formatting rule you need to pass QA and maintain high ratings.',
    breadcrumbLabel: 'GoTranscript Guidelines',
    toolKey: 'brand-guideline',
    relatedSlugs: ['/gotranscript-transcription-format', '/gotranscript-style-guide', '/gotranscript-inaudible-tags', '/gotranscript-transcription-rules', '/rev-transcript-guidelines', '/guideline-format'],
    indexable: true,
    ...
    faq: [
      ...
      { q: 'How does GoTranscript format speaker labels?', a: 'Speaker labels are bold, followed by a colon and a single space: Speaker 1:, David:, Interviewer:. Use names or descriptive roles when known. If you cannot identify who is speaking, prefix a question mark: ?David: or ?Speaker 3:. Always label even single-speaker files.' },
      { q: 'How is inaudible audio marked in GoTranscript?', a: 'Use [inaudible 00:00:00] when speech cannot be heard (noise/recording) and [unintelligible 00:00:00] when speech is heard but not understood (accent/manner). Both use full HH:MM:SS timestamps and must be bold. Do not invent other markings.' },
      { q: 'What is GoTranscript\'s accuracy requirement?', a: 'GoTranscript editors rate accuracy on a 1–5 scale (96–100% = score 5). There is no published "minimum accuracy percentage" on their guidelines page. Consistent formatting compliance and strong ratings determine continued access to jobs.' },
    ],
  },
  {
    path: '/gotranscript-transcription-format',
    title: 'GoTranscript Timestamp Format [00:00:00] | VideoText',
    description: 'GoTranscript timestamp rules: bold [00:00:00], every 2 minutes vs every speaker change, file-relative time, and test job exception. Official guidelines verified 2026-09-12.',
    h1: 'GoTranscript Timestamp Format: [00:00:00] Rules Explained',
    intro: 'When does GoTranscript require timestamps? This guide covers the exact [00:00:00] format, every-2-minutes vs every-speaker-change types, bold formatting, file-relative time, and why the qualification test has no timestamping.',
    breadcrumbLabel: 'GoTranscript Timestamp Format',
    toolKey: 'brand-guideline',
    relatedSlugs: ['/gotranscript-guidelines', '/gotranscript-style-guide', '/gotranscript-inaudible-tags', '/gotranscript-transcription-rules', '/guideline-format'],
    indexable: true,
    ...
    faq: [
      ...
      { q: 'Every 2 minutes or every speaker change — which applies?', a: 'Check the job instructions. GoTranscript supports two timestamping types: periodic (every 2 minutes) or at every speaker change. Only one type applies per file. Using the wrong type causes QA failures.' },
      { q: 'Must GoTranscript timestamps be bold?', a: 'Yes. Timestamps, speaker labels, and all time-stamped tags ([inaudible 00:00:00], [pause 00:00:00], etc.) must be bold. Plain-text exports should preserve bold formatting where the editor supports it.' },
      { q: 'What is file-relative timestamping on GoTranscript?', a: 'When you transcribe a segment of a longer file (e.g. minutes 20–30), timestamps start at [00:20:00], not [00:00:00]. Always consider the whole file position when placing stamps.' },
    ],
  },
  {
    path: '/gotranscript-inaudible-tags',
    title: 'GoTranscript Inaudible Tags [inaudible] & [crosstalk] | VideoText',
    description: 'GoTranscript inaudible vs unintelligible tags, [crosstalk] for overlaps, and sound event rules. Full HH:MM:SS format, bold. Verified against official guidelines.',
    h1: 'GoTranscript Inaudible Tags: [inaudible], [unintelligible] & [crosstalk]',
    intro: 'Which tag when audio is unclear? GoTranscript uses [inaudible 00:00:00] and [unintelligible 00:00:00] — not interchangeable — plus [crosstalk] for overlapping speech. Full rules with examples.',
    breadcrumbLabel: 'GoTranscript Inaudible Tags',
    toolKey: 'brand-guideline',
    relatedSlugs: ['/gotranscript-guidelines', '/gotranscript-transcription-format', '/gotranscript-style-guide', '/gotranscript-transcription-rules', '/guideline-format'],
    indexable: true,
    ...
    faq: [
      ...
      { q: 'Can I use plain [inaudible] without a timestamp?', a: 'No. GoTranscript requires [inaudible 00:00:00] with the full hours:minutes:seconds timestamp at the point of unclear audio. Short forms like [inaudible 3:45] are incorrect.' },
      { q: 'What sound events besides inaudible does GoTranscript allow?', a: '[silence] for 4–10 second pauses, [pause 00:00:00] bold on a separate line for pauses over 10 seconds, [background noise], [laughs], [laughter], and [foreign language] when applicable. Notes are lowercase, present tense, max two words.' },
      { q: 'Should I guess at unclear words on GoTranscript?', a: 'Never guess. Use [inaudible 00:00:00] or [unintelligible 00:00:00] at the exact position. Inventing custom tags or leaving blanks causes QA failures.' },
    ],
  },
  {
    ...
    intro: 'GoTranscript speaker label rules: bold format, names vs roles, and ? prefix when uncertain — plus the full style reference for punctuation, verbatim, and special notations.',
    breadcrumbLabel: 'GoTranscript Style Guide',
    toolKey: 'brand-guideline',
    relatedSlugs: ['/gotranscript-guidelines', '/gotranscript-transcription-format', '/gotranscript-inaudible-tags', '/gotranscript-transcription-rules', '/rev-style-guide', '/guideline-format'],
    indexable: true,
    ...
    faq: [
      ...
      { q: 'How does GoTranscript handle simultaneous speech?', a: 'Use [crosstalk] when speakers talk over each other. Place it on its own line or inline where the overlap occurs. Do not substitute [inaudible] for crosstalk — they are separate tags in GoTranscript\'s official guidelines.' },
  ...
  },
  {
    ...
    intro: 'GoTranscript clean vs full verbatim rules, slang expansion, filler removal, and qualification test format — plus QA thresholds and the most common formatting mistakes that cause rejections.',
    breadcrumbLabel: 'GoTranscript Transcription Rules',
    toolKey: 'brand-guideline',
    relatedSlugs: ['/gotranscript-guidelines', '/gotranscript-inaudible-tags', '/gotranscript-transcription-format', '/gotranscript-style-guide', '/scribie-transcription-rules', '/guideline-format'],
    indexable: true,
    ...
    faq: [
      ...
      { q: 'What does GoTranscript pay per audio minute?', a: 'Pay rates are not listed on GoTranscript\'s published transcription guidelines. Rates vary by language, audio quality, and your experience level on the platform. Check your GoTranscript worker dashboard for current pay tiers.' },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'What is the passing score for GoTranscript?', a: 'GoTranscript does not publish an exact passing score on their guidelines page. Test transcripts are evaluated by their team. After approval, editors rate ongoing work on a 1–5 accuracy scale (96–100% = score 5).' },
      { q: 'What is the biggest mistake candidates make on the GoTranscript test?', a: 'The most common test failures are: (1) adding timestamps when the test explicitly requires none; (2) keeping filler words that clean verbatim requires you to remove; (3) wrong inaudible format — use [inaudible 00:00:00] with full HH:MM:SS, not plain [inaudible].' },
      { q: 'How can I practice for the GoTranscript test?', a: 'Use VideoText\'s Guideline Format tool with the GoTranscript preset: paste a draft transcript, remove fillers, apply bold speaker labels, and use correct [inaudible 00:00:00] tags. Practice clean verbatim without timestamps to match the actual test format.' },
    ],
  },
