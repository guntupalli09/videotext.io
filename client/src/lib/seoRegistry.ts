...
const MANUAL_REGISTRY: SeoRegistryEntry[] = [
  ...
  },
  {
    ...
    description: 'GoTranscript transcription format: bold [00:00:00] timestamps (when job requires), speaker labels, inaudible/unintelligible tags, paragraph rules, and number formatting. Full reference guide.',
    h1: 'GoTranscript Transcription Format: Timestamps, Speaker Labels & Rules',
    intro: 'A detailed format reference for GoTranscript transcribers. Learn the exact syntax for job-specific timestamps, bold speaker labels, inaudible and unintelligible tags, and paragraph structure requirements.',
    ...
    faq: [
      ...
      { q: 'How are numbers formatted in GoTranscript transcripts?', a: 'Spell out single-digit numbers (zero through nine); use numerals for 10 and above. Example: "We had five participants and 12 observers." Exceptions apply for money, years, percentages, and measurements — see the official guidelines.' },
      { q: 'How long should paragraphs be in GoTranscript?', a: 'Paragraphs should not exceed ~500 symbols (about 100 words or 3–4 lines). Break longer speeches into smaller paragraphs for readability. When timestamping at speaker changes, start a new paragraph with the timestamp and speaker label.' },
