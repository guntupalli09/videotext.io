        ...
        <div className="flex items-center justify-between px-6 py-3 bg-blue-50 dark:bg-blue-900/20 border-b border-blue-100 dark:border-blue-900/30">
          <div className="flex items-center gap-4 text-sm">
            <span className="text-gray-600 dark:text-gray-400">
              Processed in <span className="font-semibold text-blue-600 dark:text-blue-400">{processingTime}</span>
            </span>
            <span className="text-gray-400">•</span>
            <span className="text-gray-600 dark:text-gray-400">{fileSize}</span>
          </div>
          <div className="text-sm text-gray-600 dark:text-gray-400">
            <span className="font-semibold text-blue-600 dark:text-blue-400">463 min</span> remaining this month
          </div>
        </div>
      </div>
