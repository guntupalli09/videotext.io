    ...
    <div className="space-y-6">
      ...
      >
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-700 rounded-full text-white shadow-lg">
          ...
          <span className="text-sm font-medium uppercase">{plan.type} plan</span>
        </div>
      </motion.div>
      ...
      >
        <div className="flex items-start gap-3 mb-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-3xl font-bold font-mono-data text-blue-900 dark:text-blue-100">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-blue-600 dark:text-blue-400">
            {plan.type} plan • Resets <span className="font-mono-data">{plan.resetDate}</span>
          </p>
        </div>
      </motion.div>
      ...
      >
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between pb-4 border-b border-gray-200 dark:border-gray-800">
            ...
            <div className="px-3 py-1 bg-gradient-to-r from-blue-600 to-blue-700 rounded-full text-white text-xs font-medium uppercase">
              {plan.type}
            </div>
          </div>
      ...
      {plan.type !== 'pro' && (
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="w-full py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-medium rounded-xl shadow-lg hover:shadow-xl transition-shadow"
        >
          Upgrade to Pro
        </motion.button>
      )}
