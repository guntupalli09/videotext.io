...
| Area | Variables |
|------|-----------|
| **API** | `PORT` (default 3001), `NODE_ENV`, `CORS_ORIGINS` (comma-separated), `EXTENSION_ORIGINS` (comma-separated `chrome-extension://<id>` origins for the Chrome extension; unset allows none) |
